...
bash $L/scripts/run_matrix.sh $L/out/s4_matrix_w08.json RL_YCRED_W=0.8 RL_APP_DATA=/nonexistent
# w=0.7 (shipped default): board first, then book with the F2 parity gate ON
RL_REPO="$HERE" python3 "$HERE/boot_guard.py" stream_B /home/claude/rl_workspace/rl_after/rl_model_data.json /home/claude/rl_workspace/rl_after/_merged_recover.py
