...
BOARD_MD5_GOOD = 'cdae239d5865be9463c4ef461daf0a35'   # ITEM 411 D1 (owner rulings v467/v469): accepted R19 balanced/strict board (advanced from 1373e824, the ITEM 408 STOP-1 board)
BAD_PREFIX = 'd7a95e8d'
...
def board_oracle():
    ...
    movers = None
    ref_path = os.path.join(FIX, 'reference_vector_cdae239d.json')
    ...
    record('ORACLE_accepted_board_zero_movers', ok,
           "rc=%s md5=%s active=%s sumv=%s sheezel=%s vector_movers=%s ref_present=%s (expect cdae239d/804/702917/11169/0)"
