...
BOARD_MD5_GOOD = '4939d74082219e84c4f4a33a096c1ec8'   # ITEM 411 D1 (owner rulings v467/v469): accepted R19 balanced/strict board (advanced from 1373e824, the ITEM 408 STOP-1 board)
BAD_PREFIX = 'd7a95e8d'
...
def green1():
    ...
    ok = ok and facts.get('active') == 804 and facts.get('sum_v') == 767198 and facts.get('sheezel') == 9655
    # C5: compare the COMPLETE active-player value vector against the accepted reference — require ZERO movers.
    movers = None
    ref_path = os.path.join(FIX, 'reference_vector_4939d740.json')
