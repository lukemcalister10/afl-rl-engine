...
historical board id: forward_vector_4a52cc44.json and the identity below are this round's.

Run:  python3 test_forward_lens_4a52cc44.py      (exit 0 == the committed forward view matches this oracle)
"""
import hashlib
import json
import os
...
FORWARD_BOARD_MD5_GOOD = '4a52cc4490f950c7b7856fc28ddcb949'
FORWARD_REFERENCE = 'forward_vector_4a52cc44.json'
...
def main():
    ...
    if fails:
        return 1
    print('FORWARD ORACLE OK: board 4a52cc44 active 804 '
          '+1 sum 639195 sheezel 11469 | +2 sum 204983 sheezel 2735 '
          '| seal 1901fb80 (expect 4a52cc44/804/639195/204983/0)')
    return 0
