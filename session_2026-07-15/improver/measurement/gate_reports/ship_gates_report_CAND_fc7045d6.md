# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ fc7045d6 — NOT AN ENDORSED STATE — head fc7045d6 store 340a7a32 config c2d233aec104
...
=== SHIP GATES BOARD — head fc7045d6 store 340a7a32 config c2d233aec104 — suite 764a0d91 — 2026-07-15 ===
...
A2        FAIL    | FAIL    | FAIL     Curtis>=0.90xWard: 1619 vs 1934 (Ward=2149, ratio=0.753) [AMENDED 02/07/2026; UNCHANGED at 0.90 by ruling D7 — Luke: "we can look at Curtis down the line"]; Weddle>Ward: 1661 vs 2149
...
A6        PASS    | PASS    | PASS     yr1-3 RUC median=484 (n=12, pooled — thin slice) vs pick-matched MID kernel median=656 (n=67, bw=0.6 log-pick, RATIFIED 02/07)
...
B1        PASS    | PASS    | PASS     JULY-8 construction (owner-ruled 2026-07-13, register v52 — CONFORMED; raw class-year sums of Vpath averaged UNWEIGHTED across 17 classes 2004-2020 incurve ND+RD; CANDIDATE regenerated this run — engine fc7045d6 store 340a7a32 config c2d233aec104): y1=71083.5 y2=82305.2 y3=86324.1 y4=91895.4 y5=92391.0 y6=88467.2 y7=79212.5; den=min(y1,y2)=y1=71083.5; ratios y4=1.2928(above-guide) y5=1.2998(above-guide) y6=1.2446(in-guide); hard<=1.30 -> PASS x3; guide 1.20-1.25 ADVISORY (margin reported, never gates)
B2        PASS    | PASS    | PASS     leave-cohort-out sensitivity (2014-2018 ND held out): median |IS-WF| leakage=0.000 %-pts (FULL precision; tol 0.5 UNCHANGED, SET 02/07/2026); worst cells RUC|GOOD|T5:6.80, GEN_DEF|GOOD|T2:4.53, GEN_DEF|GOOD|T4:4.13, KEY_DEF|GOOD|T3:3.29; GOOD>BUST sep GEN_DEF 38.3/1.0, GEN_FWD 39.9/0.6, KEY_DEF 48.4/1.1, KEY_FWD 62.7/0.6, MID 48.3/0.5, RUC 26.9/0.4 [cert engine fc7045d6 store 340a7a32 config c2d233ae]
B3        PASS    | PASS    | PASS     CANDIDATE book stable seal (regenerated this run — engine fc7045d6 store 340a7a32 config c2d233aec104): MATCHES the sealed baseline. current=2a77d83443187589.. (2649 players) vs baseline=2a77d83443187589.. (2649 players, sealed head fc7045d6) [full stable-keyed content seal; raw-file sha is id(p)-keyed / non-deterministic by design]
B4        PASS    | PASS    | PASS     regenerated rl_app_data.json md5=dc43d602 vs shipped dc43d602 (byte-agree gate; export exit=0)
B5        FEATURE | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 60 saves, aggregate lift +2189; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)
...
VERDICT: FAIL=3  FEATURE=1  PASS=17  PENDING=4  STRUCK=1  (348s)
```
...
| 2008 | 4 | 100 | 120 | 152 | 162 | 146 | 128 | 116 |
...
| **July-8 raw-sum AVG (THE GATED ROW)** | **—** | **71084** | **82305** | **86324** | **91895** | **92391** | **88467** | **79212** |

B5 FLOOR-SAVES table (n=60, aggregate lift=+2189 — printed every gates-board run, the new alarm surface):
...
| 20 | Jai Newcombe | MID | — | — | 4527 | — | — |
| 21 | Darcy Wilmot | GEN_DEF | 3967 | 3732 | 4450 | +483 | +718 |
| 22 | Murphy Reid | GEN_FWD | 3953 | 3742 | 4413 | +460 | +671 |
| 23 | Nick Blakey | GEN_DEF | 3598 | 3266 | 4354 | +756 | +1088 |
| 24 | Ryley Sanders | MID | 4129 | 3926 | 4246 | +117 | +320 |
| 25 | Riley Thilthorpe | KEY_FWD | 3818 | 3702 | 4245 | +427 | +543 |
| 26 | Matt Rowell | MID | 4185 | 3752 | 4231 | +46 | +479 |
| 27 | Jason Horne-Francis | MID | 3996 | 3702 | 4182 | +186 | +480 |
| 28 | Mac Andrew | KEY_DEF | 3691 | 3504 | 4129 | +438 | +625 |
| 29 | Kysaiah Pickett | GEN_FWD | 3496 | 3076 | 4105 | +609 | +1029 |
