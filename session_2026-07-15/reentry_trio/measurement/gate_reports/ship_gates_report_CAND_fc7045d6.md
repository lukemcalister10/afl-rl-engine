...
B2        PASS    | PASS    | PASS     leave-cohort-out sensitivity (2014-2018 ND held out): median |IS-WF| leakage=0.000 %-pts (FULL precision; tol 0.5 UNCHANGED, SET 02/07/2026); worst cells RUC|GOOD|T5:6.06, KEY_DEF|GOOD|T5:4.65, GEN_DEF|GOOD|T2:4.27, GEN_DEF|GOOD|T4:4.27; GOOD>BUST sep GEN_DEF 38.2/1.0, GEN_FWD 39.7/0.6, KEY_DEF 48.3/1.1, KEY_FWD 62.5/0.6, MID 48.1/0.5, RUC 26.8/0.4 [cert engine fc7045d6 store b1fd0bce config c2d233ae]
...
VERDICT: FAIL=3  FEATURE=1  PASS=17  PENDING=4  STRUCK=1  (390s)
```
