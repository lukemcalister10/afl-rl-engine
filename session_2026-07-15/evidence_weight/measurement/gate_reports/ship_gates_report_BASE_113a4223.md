# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ 113a4223 — NOT AN ENDORSED STATE — head 113a4223 store 340a7a32 config c2d233aec104
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ 113a4223 — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head 113a4223 store 340a7a32 config c2d233aec104 — suite 764a0d91 — 2026-07-15 ===
...
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=7a07e369 · PREVIOUS=efea88e5 · CURRENT=113a4223 ===
A1        PASS    | PASS    | PASS     Duursma>Uwland: 4566 vs 2833
A2        FAIL    | FAIL    | FAIL     Curtis>=0.90xWard: 1555 vs 1562 (Ward=1735, ratio=0.896) [AMENDED 02/07/2026; UNCHANGED at 0.90 by ruling D7 — Luke: "we can look at Curtis down the line"]; Weddle>Ward: 1661 vs 1735
A3   [DC] FAIL    | FAIL    | FAIL     Connor Rozee: 2026=2955 2025=4464 ratio=0.66 (need >=0.75) [evaluated PRE-LTI-layer — Luke 02/07; AMENDED 0.80->0.75 Luke D7 data-caused (out for 2026), knife-edge by design]
          triage: [DC] gate — attribute ENGINE- vs DATA-caused BEFORE this blocks (SHIP_GATES PROCESS)
A4        PASS    | PASS    | PASS     Harley Reid board rank=29 ev=3775 (need TOP 40)
A5        PASS    | PASS    | PASS     Jack Ginnivan=1941 (floor 1600); Jake Bowey=3325 (floor 2100); Nick Blakey=3502 (floor 2600) [SCAR floors — RE-BASE if PVC re-levels]
...
A8   [DC] PASS    | PASS    | PASS     Berry=2836 Tsatas=1243 ratio=2.28x (need >=2.00x) [display de-ambiguated D4 02/07]
...
A12  [DC] FAIL    | FAIL    | FAIL     Travaglia>Moraes: 824 vs 1042; Smillie>Retschko: 1349 vs 873
          triage: [DC] gate — attribute ENGINE- vs DATA-caused BEFORE this blocks (SHIP_GATES PROCESS)
A13       PENDING | PENDING | PENDING  PVC stage not run; advisory vs stand-in PVC[1]=3000: George Wardlaw=3191 lineball=True; Levi Ashcroft=3259 lineball=True
A14       PENDING | PENDING | PENDING  PVC stage not run; advisory vs stand-in PVC[8]=1706: Trent Rivers=1798 lineball=True; Zach Reid=1683 lineball=True; Jase Burgoyne=2098 lineball=False
A15       STRUCK  | STRUCK  | STRUCK   Luke 02/07/2026 — convexity dimension seeded as V_NEXT #1
B1        PASS    | PASS    | PASS     JULY-8 construction (owner-ruled 2026-07-13, register v52 — CONFORMED; raw class-year sums of Vpath averaged UNWEIGHTED across 17 classes 2004-2020 incurve ND+RD; CANDIDATE regenerated this run — engine 113a4223 store 340a7a32 config c2d233aec104): y1=69851.3 y2=79473.9 y3=82291.3 y4=88429.5 y5=87156.2 y6=80945.8 y7=71701.9; den=min(y1,y2)=y1=69851.3; ratios y4=1.2660(above-guide) y5=1.2477(in-guide) y6=1.1588(below-guide); hard<=1.30 -> PASS x3; guide 1.20-1.25 ADVISORY (margin reported, never gates)
B2        PASS    | PASS    | PASS     leave-cohort-out sensitivity (2014-2018 ND held out): median |IS-WF| leakage=0.000 %-pts (FULL precision; tol 0.5 UNCHANGED, SET 02/07/2026); worst cells GEN_FWD|GOOD|T1:2.99, MID|GOOD|T2:2.82, GEN_DEF|GOOD|T3:2.63, GEN_FWD|GOOD|T4:2.47; GOOD>BUST sep GEN_DEF 41.5/1.0, GEN_FWD 39.3/0.6, KEY_DEF 51.1/1.1, KEY_FWD 61.1/0.6, MID 50.8/0.5, RUC 26.9/0.4 [cert engine 113a4223 store 340a7a32 config c2d233ae]
B3        PASS    | PASS    | PASS     CANDIDATE book stable seal (regenerated this run — engine 113a4223 store 340a7a32 config c2d233aec104): MATCHES the sealed baseline. current=92e401a53420b188.. (2649 players) vs baseline=92e401a53420b188.. (2649 players, sealed head 113a4223) [full stable-keyed content seal; raw-file sha is id(p)-keyed / non-deterministic by design]
B4        PASS    | PASS    | PASS     regenerated rl_app_data.json md5=24159c49 vs shipped 24159c49 (byte-agree gate; export exit=0)
B5        FEATURE | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 60 saves, aggregate lift +2210; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)
...
VERDICT: FAIL=3  FEATURE=1  PASS=17  PENDING=4  STRUCK=1  (532s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 124 | 162 | 162 | 171 | 148 | 133 |
| 2005 | 4 | 100 | 143 | 136 | 177 | 172 | 163 | 138 |
| 2006 | 4 | 100 | 118 | 122 | 134 | 132 | 131 | 112 |
| 2007 | 5 | 100 | 114 | 106 | 107 | 134 | 123 | 104 |
| 2008 | 4 | 100 | 118 | 146 | 160 | 142 | 123 | 109 |
| 2009 | 2 | 100 | 111 | 95 | 97 | 96 | 85 | 73 |
| 2010 | 4 | 100 | 119 | 122 | 140 | 135 | 115 | 93 |
| 2011 | 4 | 100 | 117 | 128 | 146 | 143 | 134 | 110 |
| 2012 | 3 | 100 | 101 | 109 | 107 | 103 | 98 | 82 |
| 2013 | 5 | 100 | 121 | 131 | 152 | 153 | 137 | 104 |
| 2014 | 4 | 100 | 111 | 119 | 125 | 112 | 111 | 107 |
| 2015 | 2 | 100 | 106 | 105 | 105 | 103 | 102 | 100 |
| 2016 | 4 | 100 | 114 | 122 | 139 | 126 | 126 | 108 |
| 2017 | 3 | 100 | 107 | 108 | 97 | 91 | 90 | 83 |
| 2018 | 4 | 100 | 114 | 106 | 115 | 110 | 100 | 92 |
| 2019 | 5 | 100 | 101 | 104 | 111 | 121 | 109 | 91 |
| 2020 | 2 | 100 | 101 | 98 | 91 | 95 | 91 | — |
| _indexed AVG (SHAPE DIAGNOSTIC — DEMOTED 2026-07-13, NOT the gate)_ | _4_ | _100_ | _114_ | _119_ | _127_ | _126_ | _117_ | _102_ |
| **July-8 raw-sum AVG (THE GATED ROW)** | **—** | **69851** | **79474** | **82291** | **88430** | **87156** | **80946** | **71702** |

B5 FLOOR-SAVES table (n=60, aggregate lift=+2210 — printed every gates-board run, the new alarm surface):
...
| Finlay Macrae | — | 6 | 76 | 101.3 | 114 | +38 | clear |
| Jake Melksham | — | 17 | 15 | 82.9 | 53 | +38 | clear |
| Nicholas Coffield | — | 9 | 18 | 87.0 | 55 | +37 | clear |
...
| Ryan Gardner | — | 11 | 12 | 18.3 | 35 | +23 | clear |
...
| Liam Henry | — | 7 | 66 | 85.4 | 87 | +21 | clear |
...
| Oskar Baker | — | 9 | 18 | 26.0 | 33 | +15 | clear |
...
## Board top-50 (A4 context) — CONTROL 7a07e369 · PREVIOUS efea88e5 · CURRENT 113a4223
...
| 3 | Luke Jackson | RUC | 7799 | 6803 | 7834 | +35 | +1031 |
| 4 | Nasiah Wanganeen-Milera | MID | 6606 | 5794 | 6764 | +158 | +970 |
| 5 | Tristan Xerri | RUC | 6649 | 5795 | 6579 | -70 | +784 |
| 6 | Josh Treacy | KEY_FWD | — | — | 6531 | — | — |
| 7 | Max Holmes | MID | 6269 | 5386 | 6472 | +203 | +1086 |
