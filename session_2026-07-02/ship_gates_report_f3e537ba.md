# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ f3e537ba — NOT AN ENDORSED STATE — head f3e537ba store 644d1254
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ f3e537ba — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head f3e537ba store 644d1254 — suite 764a0d91 — 2026-07-03 ===
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=8aed420a · PREVIOUS=c8051893 · CURRENT=f3e537ba ===
...
A6        PASS    | PASS    | PASS     yr1-3 RUC median=400 (n=13, pooled — thin slice) vs pick-matched MID kernel median=570 (n=66, bw=0.6 log-pick, RATIFIED 02/07)
...
A11  [DC] PASS    | PASS    | PASS     Farrow>Patterson: 1644 vs 908; Cumming>Annable: 1948 vs 1485
A12  [DC] FAIL    | FAIL    | FAIL     Travaglia>Moraes: 712 vs 887; Smillie>Retschko: 993 vs 730
          triage: [DC] gate — attribute ENGINE- vs DATA-caused BEFORE this blocks (SHIP_GATES PROCESS)
...
B1        PASS    | PASS    | PASS     cross-cohort AVERAGE peak N=4 AVG(peak)=130 (need peak in yrs 4-6, >100; pre-peak dips of the AVERAGE <5% tolerated, path_ok=True; per-cohort UNGATED, table printed every run — Luke redefinition 02/07 D5); avg row: 1:100 2:120 3:124 4:130 5:126 6:120 7:105; cohorts n=17; matrix=s4_matrix_v23.json
...
B4        FAIL    | FAIL    | FAIL     regenerated rl_app_data.json md5=0d3bd5ba vs shipped b8f9e998 (byte-agree gate; export exit=0)
B5        FAIL    | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 51 saves, aggregate lift +1319; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)  <- MOVED
...
VERDICT: FAIL=4  FEATURE=1  PASS=12  PENDING=5  STRUCK=1  (127s)
```
...
B5 FLOOR-SAVES table (n=51, aggregate lift=+1319 — printed every gates-board run, the new alarm surface):
...
| Luke Pedlar | Adelaide | 6 | 66 | 124.2 | 128 | +62 | clear |
...
| Jake Melksham | Essendon | 17 | 11 | 74.5 | 43 | +32 | clear |
...
| Nicholas Coffield | St Kilda | 9 | 16 | 85.2 | 42 | +26 | clear |
...
| Bailey Macdonald | Hawthorn | 4 | 92 | 79.8 | 94 | +2 | clear |
| Kaleb Smith | Richmond | 4 | 93 | 84.2 | 94 | +1 | clear |
| Bailey Scott | North Melbourne | 8 | 23 | 20.1 | 24 | +1 | clear |

## Board top-50 (A4 context) — CONTROL 8aed420a · PREVIOUS c8051893 · CURRENT f3e537ba
