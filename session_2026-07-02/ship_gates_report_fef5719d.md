# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ fef5719d — NOT AN ENDORSED STATE — head fef5719d store 340a7a32 config c2d233aec104
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ fef5719d — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head fef5719d store 340a7a32 config c2d233aec104 — suite 764a0d91 — 2026-07-14 ===
...
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=7a07e369 · PREVIOUS=efea88e5 · CURRENT=fef5719d ===
...
A10  [DC] PASS    | PASS    | PASS     Charlie Curnow: 2026=1313 2025=2291 ratio=0.57 (need >=0.50) [AMENDED 0.70->0.50 Luke 02/07 data-caused, PROVISIONAL — review at season-complete]
...
B1        PASS    | PASS    | PASS     JULY-8 construction (owner-ruled 2026-07-13, register v52 — CONFORMED; raw class-year sums of Vpath averaged UNWEIGHTED across 17 classes 2004-2020 incurve ND+RD; CANDIDATE regenerated this run — engine fef5719d store 340a7a32 config c2d233aec104): y1=69840.0 y2=79466.3 y3=82273.5 y4=88352.1 y5=86910.6 y6=80533.1 y7=71268.0; den=min(y1,y2)=y1=69840.0; ratios y4=1.2651(above-guide) y5=1.2444(in-guide) y6=1.1531(below-guide); hard<=1.30 -> PASS x3; guide 1.20-1.25 ADVISORY (margin reported, never gates)
B2        PASS    | PASS    | PASS     leave-cohort-out sensitivity (2014-2018 ND held out): median |IS-WF| leakage=0.000 %-pts (FULL precision; tol 0.5 UNCHANGED, SET 02/07/2026); worst cells GEN_DEF|GOOD|T5:5.30, RUC|GOOD|T5:3.27, GEN_DEF|GOOD|T2:3.14, RUC|GOOD|T3:2.42; GOOD>BUST sep GEN_DEF 41.5/0.9, GEN_FWD 39.0/0.6, KEY_DEF 50.0/1.1, KEY_FWD 62.3/0.6, MID 50.1/0.5, RUC 26.1/0.3 [cert engine fef5719d store 340a7a32 config c2d233ae]
B3        PASS    | PASS    | DIFFERS-BY-DESIGN CANDIDATE book stable seal (regenerated this run — engine fef5719d store 340a7a32 config c2d233aec104): candidate head fef5719d != sealed head 2030e5df — new version; the v2.6 book must be RE-SEALED at the bake (owner action). current=2a2df435fad4784e.. (2649 players) vs baseline=d371a27c787a34c9.. (2649 players, sealed head 2030e5df) [full stable-keyed content seal; raw-file sha is id(p)-keyed / non-deterministic by design]  <- MOVED
B4        PASS    | PASS    | PASS     regenerated rl_app_data.json md5=e6a8e6ef vs shipped e6a8e6ef (byte-agree gate; export exit=0)
B5        FEATURE | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 60 saves, aggregate lift +2230; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)
...
VERDICT: DIFFERS-BY-DESIGN=1  FAIL=3  FEATURE=1  PASS=16  PENDING=4  STRUCK=1  (474s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 125 | 162 | 163 | 171 | 148 | 133 |
| 2005 | 4 | 100 | 143 | 136 | 177 | 172 | 162 | 137 |
| 2006 | 4 | 100 | 118 | 122 | 134 | 132 | 131 | 112 |
| 2007 | 5 | 100 | 114 | 106 | 107 | 134 | 123 | 104 |
| 2008 | 4 | 100 | 118 | 146 | 160 | 142 | 123 | 109 |
| 2009 | 2 | 100 | 111 | 95 | 97 | 96 | 85 | 72 |
| 2010 | 4 | 100 | 119 | 122 | 140 | 135 | 114 | 92 |
| 2011 | 4 | 100 | 117 | 128 | 146 | 142 | 132 | 109 |
| 2012 | 3 | 100 | 101 | 109 | 107 | 103 | 98 | 81 |
| 2013 | 4 | 100 | 121 | 131 | 152 | 151 | 137 | 104 |
| 2014 | 4 | 100 | 111 | 119 | 124 | 111 | 111 | 107 |
| 2015 | 2 | 100 | 106 | 104 | 105 | 103 | 102 | 99 |
| 2016 | 4 | 100 | 114 | 122 | 139 | 125 | 125 | 108 |
| 2017 | 3 | 100 | 107 | 108 | 97 | 91 | 88 | 82 |
| 2018 | 4 | 100 | 114 | 106 | 115 | 109 | 99 | 90 |
| 2019 | 5 | 100 | 101 | 104 | 111 | 120 | 109 | 91 |
| 2020 | 2 | 100 | 101 | 98 | 91 | 95 | 90 | — |
| _indexed AVG (SHAPE DIAGNOSTIC — DEMOTED 2026-07-13, NOT the gate)_ | _4_ | _100_ | _114_ | _119_ | _127_ | _126_ | _116_ | _102_ |
| **July-8 raw-sum AVG (THE GATED ROW)** | **—** | **69840** | **79466** | **82273** | **88352** | **86911** | **80533** | **71268** |

B5 FLOOR-SAVES table (n=60, aggregate lift=+2230 — printed every gates-board run, the new alarm surface):
...
## Board top-50 (A4 context) — CONTROL 7a07e369 · PREVIOUS efea88e5 · CURRENT fef5719d
...
| 11 | Lachlan Ash | GEN_DEF | 5187 | 4611 | 5287 | +100 | +676 |
| 12 | Will Ashcroft | MID | 5155 | 4768 | 5205 | +50 | +437 |
| 13 | Noah Anderson | MID | 4765 | 4091 | 4767 | +2 | +676 |
| 14 | Caleb Serong | MID | 4701 | 4170 | 4728 | +27 | +558 |
| 15 | Archie Roberts | GEN_DEF | 4577 | 4668 | 4582 | +5 | -86 |
| 16 | Bailey Smith | MID | 5605 | 4715 | 4572 | -1033 | -143 |
...
| 26 | Brodie Grundy | RUC | 3959 | 3314 | 3913 | -46 | +599 |
...
| 38 | Timothy English | RUC | 3349 | 2916 | 3421 | +72 | +505 |
