# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ da56bccf — NOT AN ENDORSED STATE — head da56bccf store a2fbc9a0 config d88404f07633
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ da56bccf — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head da56bccf store a2fbc9a0 config d88404f07633 — suite 764a0d91 — 2026-07-09 ===
...
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=efea88e5 · PREVIOUS=c8051893 · CURRENT=da56bccf ===
...
VERDICT: DIFFERS-BY-DESIGN=1  FAIL=3  FEATURE=1  PASS=16  PENDING=4  STRUCK=1  (478s)
```
...
## Board top-50 (A4 context) — CONTROL efea88e5 · PREVIOUS c8051893 · CURRENT da56bccf
