# ship_gates_check report — STATE: CANDIDATE W4+L1c+KPF R3fix (2026-07-09; RL_PVCFIT held out per R3; board 799b2290 frozen v3.4; store e1b4d8bf; CURRENT) — head 4b08796c store a2fbc9a0 config d88404f07633
...
=== SHIP GATES BOARD — head 4b08796c store a2fbc9a0 config d88404f07633 — suite 764a0d91 — 2026-07-09 ===
...
VERDICT: FAIL=3  FEATURE=1  PASS=17  PENDING=4  STRUCK=1  (446s)
```
