# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ fbefdc2b — NOT AN ENDORSED STATE — head fbefdc2b store e1b4d8bf
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ fbefdc2b — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head fbefdc2b store e1b4d8bf — suite 764a0d91 — 2026-07-08 ===
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=efea88e5 · PREVIOUS=c8051893 · CURRENT=fbefdc2b ===
...
A6        PASS    | PASS    | PASS     yr1-3 RUC median=393 (n=13, pooled — thin slice) vs pick-matched MID kernel median=556 (n=67, bw=0.6 log-pick, RATIFIED 02/07)
...
B1        PASS    | PASS    | PASS     cross-cohort AVERAGE peak N=4 AVG(peak)=129 (need peak in yrs 4-6, >100; pre-peak dips of the AVERAGE <5% tolerated, path_ok=True; per-cohort UNGATED, table printed every run — Luke redefinition 02/07 D5); avg row: 1:100 2:116 3:121 4:129 5:128 6:120 7:106; cohorts n=17; matrix=s4_matrix_w09.json
...
B3        PASS    | PENDING | FAIL     book stable-key seal DIFFERS FROM baseline: current=e3d025c948731106.. (2649 players) vs baseline=5799a9ceae5ca3ef.. (2649 players, sealed head efea88e5); matrix=s4_matrix_w09.json [raw-file sha is id(p)-keyed / non-deterministic by design]  <- MOVED
B4        PASS    | FAIL    | PASS     regenerated rl_app_data.json md5=b9304bf2 vs shipped b9304bf2 (byte-agree gate; export exit=0)  <- MOVED
B5        FEATURE | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 60 saves, aggregate lift +1923; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)
...
VERDICT: FAIL=4  FEATURE=1  PASS=16  PENDING=4  STRUCK=1  (184s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 127 | 164 | 163 | 174 | 151 | 137 |
| 2005 | 4 | 100 | 145 | 137 | 180 | 171 | 163 | 142 |
| 2006 | 4 | 100 | 119 | 123 | 135 | 133 | 131 | 113 |
| 2007 | 5 | 100 | 116 | 107 | 111 | 133 | 126 | 106 |
| 2008 | 4 | 100 | 122 | 153 | 165 | 149 | 134 | 118 |
| 2009 | 2 | 100 | 112 | 96 | 96 | 97 | 86 | 74 |
| 2010 | 4 | 100 | 120 | 126 | 142 | 136 | 118 | 98 |
| 2011 | 4 | 100 | 118 | 130 | 148 | 146 | 139 | 115 |
| 2012 | 3 | 100 | 103 | 111 | 110 | 106 | 101 | 84 |
| 2013 | 5 | 100 | 122 | 134 | 155 | 158 | 138 | 108 |
| 2014 | 4 | 100 | 114 | 122 | 128 | 116 | 114 | 112 |
| 2015 | 4 | 100 | 107 | 106 | 107 | 105 | 104 | 100 |
| 2016 | 4 | 100 | 116 | 124 | 141 | 130 | 131 | 114 |
| 2017 | 3 | 100 | 108 | 110 | 98 | 92 | 92 | 86 |
| 2018 | 2 | 100 | 116 | 108 | 115 | 111 | 102 | 96 |
| 2019 | 5 | 100 | 101 | 106 | 113 | 122 | 111 | 96 |
| 2020 | 2 | 100 | 103 | 100 | 91 | 95 | 91 | — |
| **AVG (the gated row)** | **4** | **100** | **116** | **121** | **129** | **128** | **120** | **106** |

B5 FLOOR-SAVES table (n=60, aggregate lift=+1923 — printed every gates-board run, the new alarm surface):
...
| Oliver Wiltshire | Geelong | 3 | 13 | 86.2 | 94 | +81 | clear |
...
| Reef McInnes | Collingwood | 6 | 60 | 55.4 | 76 | +16 | LTI (2025 AND again 2026) |
...
## Board top-50 (A4 context) — CONTROL efea88e5 · PREVIOUS c8051893 · CURRENT fbefdc2b
...
| 17 | Archie Roberts | GEN_DEF | 4668 | 4597 | 4327 | -341 | -270 |
| 18 | Willem Duursma | MID | 4110 | 4160 | 4225 | +115 | +65 |
...
| 33 | Finn O'Sullivan | MID | 3427 | 3495 | 3451 | +24 | -44 |
| 34 | Nick Blakey | GEN_DEF | 3266 | 3287 | 3431 | +165 | +144 |
| 35 | Sam Lalor | MID | 3337 | 3703 | 3400 | +63 | -303 |
