# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ a5550b67 — NOT AN ENDORSED STATE — head a5550b67 store fb640ca0 config f233d1604975
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ a5550b67 — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head a5550b67 store fb640ca0 config f233d1604975 — suite 764a0d91 — 2026-08-28 ===
=== CONFIG MANIFEST (gate mode): data/model_config.json hash f233d1604975cdbd — ambient model env cleared + pinned; unknown/divergent overrides rejected (halt) ===
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=7a07e369 · PREVIOUS=efea88e5 · CURRENT=a5550b67 ===
...
A6        PASS    | PASS    | PASS     yr1-3 RUCK median=301 (n=11, pooled — thin slice) vs pick-matched MID kernel median=587 (n=70, bw=0.6 log-pick, RATIFIED 02/07)
...
A11  [DC] PASS    | PASS    | PASS     Farrow>Patterson: 2174 vs 1184; Cumming>Annable: 2434 vs 1326
...
B1        PASS    | PASS    | STRUCK   [STRUCK — Luke 2026-08-20, verbatim: "That cohort rail again was retired. Weeks ago." The JULY-8 CONSTRUCTION is RETIRED. Its law, G-COHORT (walk-forward book ratio, max 1.3), was carried by the owner-signed RULEBOOK v2.1 and its twin docs/acceptance_v2_0.json; the v3 amendment of 2026-08-20 removed that twin and records G-COHORT in RULEBOOK PART 3 as RETIRED, with its 1.3 payload written down there. RULEBOOK PART 3 is the pointer of record. Zombie note: retired while this suite was bricked at :49; surfaced HALT only on the first run after the unbricking. SCORED, NEVER FLAGGED — every figure below still prints; only the alarm is removed] JULY-8 construction (owner-ruled 2026-07-13, register v52 — CONFORMED; raw class-year sums of Vpath averaged UNWEIGHTED across 17 classes 2004-2020 incurve ND+RD; CANDIDATE regenerated this run — engine a5550b67 store fb640ca0 config f233d1604975): y1=62791.5 y2=70333.8 y3=79804.4 y4=90757.3 y5=91097.2 y6=87605.9 y7=79562.8; den=min(y1,y2)=y1=62791.5; ratios y4=1.4454(above-guide) y5=1.4508(above-guide) y6=1.3952(above-guide); RETIRED hard<=1.30 bar -> would have BREACHED at y[4, 5, 6] — SCORED, NOT FLAGGED (struck); guide 1.20-1.25 ADVISORY (margin reported, never gates)  <- MOVED
B2        PASS    | PASS    | PASS     leave-cohort-out sensitivity (2014-2018 ND held out): median |IS-WF| leakage=0.000 %-pts (FULL precision; tol 0.5 UNCHANGED, SET 02/07/2026); worst cells RUCK|GOOD|T5:3.91, SD|GOOD|T4:3.02, KPF|GOOD|T4:2.95, RUCK|GOOD|T4:2.72; GOOD>BUST sep KPD 34.3/1.2, KPF 49.3/0.5, MID 39.0/0.6, RUCK 13.7/0.2, SD 41.0/1.1, SF 37.7/0.7 [cert engine a5550b67 store fb640ca0 config f233d160]
B3        PASS    | PASS    | PASS     CANDIDATE book stable seal (regenerated this run — engine a5550b67 store fb640ca0 config f233d1604975): MATCHES the sealed baseline. current=b6f67e94c5fe7dfa.. (2650 players) vs baseline=b6f67e94c5fe7dfa.. (2650 players, sealed head a5550b67) [full stable-keyed content seal; raw-file sha is id(p)-keyed / non-deterministic by design]
B4        PASS    | PASS    | PASS     regenerated rl_app_data.json md5=530a4053 vs shipped 530a4053 (byte-agree gate; export exit=0)
B5        FEATURE | FEATURE | FAIL     floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail; #326 scope = national draftees + 225 engine-pool entrants on their signed division levels): 18 saves, aggregate lift +4784; the floor is still a pure lower bound: lowered=9 (bar 0), moved outside the floor scope=0 (bar 0); saves table printed below (the new alarm surface)  <- MOVED
...
VERDICT: FAIL=4  PASS=16  PENDING=4  STRUCK=3  (6460s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 115 | 143 | 146 | 156 | 138 | 127 |
| 2005 | 4 | 100 | 125 | 141 | 180 | 170 | 172 | 156 |
| 2006 | 4 | 100 | 116 | 133 | 163 | 162 | 159 | 145 |
| 2007 | 5 | 100 | 113 | 112 | 126 | 164 | 157 | 131 |
| 2008 | 4 | 100 | 119 | 164 | 194 | 173 | 154 | 138 |
| 2009 | 4 | 100 | 113 | 100 | 115 | 111 | 102 | 92 |
| 2010 | 4 | 100 | 116 | 127 | 153 | 150 | 129 | 104 |
| 2011 | 5 | 100 | 113 | 136 | 162 | 162 | 159 | 136 |
| 2012 | 6 | 100 | 102 | 116 | 125 | 121 | 128 | 109 |
| 2013 | 5 | 100 | 119 | 142 | 173 | 175 | 159 | 127 |
| 2014 | 4 | 100 | 120 | 137 | 151 | 137 | 149 | 142 |
| 2015 | 4 | 100 | 109 | 120 | 124 | 118 | 123 | 121 |
| 2016 | 4 | 100 | 117 | 146 | 174 | 165 | 162 | 143 |
| 2017 | 3 | 100 | 105 | 117 | 112 | 113 | 113 | 110 |
| 2018 | 5 | 100 | 109 | 109 | 114 | 128 | 114 | 111 |
| 2019 | 5 | 100 | 101 | 114 | 138 | 146 | 141 | 118 |
| 2020 | 6 | 100 | 87 | 96 | 95 | 108 | 108 | — |
| _indexed AVG (SHAPE DIAGNOSTIC — DEMOTED 2026-07-13, NOT the gate)_ | _5_ | _100_ | _112_ | _127_ | _144_ | _145_ | _139_ | _126_ |
| **July-8 raw-sum AVG (the STRUCK rail, scored but never flagged — Luke 2026-08-20)** | **—** | **62791** | **70334** | **79804** | **90757** | **91097** | **87606** | **79563** |

B5 FLOOR-SAVES table (n=18, aggregate lift=+4784 — printed every gates-board run, the new alarm surface):
...
## Board top-50 (A4 context) — CONTROL 7a07e369 · PREVIOUS efea88e5 · CURRENT a5550b67
