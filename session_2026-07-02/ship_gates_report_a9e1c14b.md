# ship_gates_check report — head a9e1c14b store 644d1254
```
=== SHIP GATES BOARD — head a9e1c14b store 644d1254 — suite 764a0d91 — 2026-07-02 ===
...
B1        PASS     cross-cohort AVERAGE peak N=4 AVG(peak)=169 (need peak in yrs 4-6, >100; pre-peak dips of the AVERAGE <5% tolerated, path_ok=True; per-cohort UNGATED, table printed every run — Luke redefinition 02/07 D5); avg row: 1:100 2:132 3:156 4:169 5:160 6:149 7:131; cohorts n=17; matrix=s4_matrix_headfix_a9e1c14b.json
B2        PASS     median |IS-WF| leakage=0.0 %-pts (tol 0.5, SET 02/07/2026 — N=5 spread 0.00); GOOD>BUST separation: GEN_DEF 59/1, GEN_FWD 43/1, KEY_DEF 60/1, KEY_FWD 66/1, MID 52/0
...
B4        FAIL     regenerated rl_app_data.json md5=d0987fd6 vs shipped b8f9e998 (byte-agree gate; export exit=0)
B5        FEATURE-ABSENT floor feature not wired at this head (v2 candidate carries it); legacy offender count = 50 (INFORMATIONAL — the alarm is retired, Luke-ruled 02/07 D7)
...
VERDICT: FAIL=7  FEATURE-ABSENT=1  PASS=9  PENDING=5  STRUCK=1  (119s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 139 | 190 | 185 | 190 | 168 | 146 |
| 2005 | 4 | 100 | 145 | 171 | 212 | 185 | 186 | 162 |
| 2006 | 4 | 100 | 142 | 172 | 190 | 182 | 173 | 148 |
| 2007 | 5 | 100 | 133 | 138 | 145 | 166 | 160 | 135 |
| 2008 | 4 | 100 | 134 | 186 | 206 | 179 | 158 | 139 |
| 2009 | 4 | 100 | 122 | 114 | 131 | 117 | 104 | 92 |
| 2010 | 4 | 100 | 143 | 165 | 186 | 170 | 155 | 130 |
| 2011 | 4 | 100 | 136 | 171 | 201 | 188 | 174 | 142 |
| 2012 | 4 | 100 | 123 | 142 | 146 | 135 | 128 | 106 |
| 2013 | 4 | 100 | 137 | 168 | 196 | 193 | 167 | 129 |
| 2014 | 4 | 100 | 134 | 163 | 177 | 160 | 152 | 145 |
| 2015 | 4 | 100 | 126 | 143 | 146 | 138 | 138 | 123 |
| 2016 | 4 | 100 | 138 | 169 | 192 | 177 | 177 | 152 |
| 2017 | 3 | 100 | 119 | 129 | 121 | 112 | 105 | 98 |
| 2018 | 3 | 100 | 126 | 151 | 147 | 147 | 128 | 118 |
| 2019 | 4 | 100 | 132 | 156 | 172 | 170 | 151 | 135 |
| 2020 | 3 | 100 | 112 | 129 | 113 | 110 | 110 | — |
| **AVG (the gated row)** | **4** | **100** | **132** | **156** | **169** | **160** | **149** | **131** |
