# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ 59b1927a — NOT AN ENDORSED STATE — head 59b1927a store e1b4d8bf
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ 59b1927a — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head 59b1927a store e1b4d8bf — suite 764a0d91 — 2026-07-06 ===
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=efea88e5 · PREVIOUS=c8051893 · CURRENT=59b1927a ===
...
B4        PASS    | FAIL    | FAIL     regenerated rl_app_data.json md5=99823bb8 vs shipped 7d1eeef8 (byte-agree gate; export exit=0)  <- MOVED
...
VERDICT: FAIL=4  FEATURE=1  NOT-RUN=1  PASS=15  PENDING=4  STRUCK=1  (135s)
```
...
## Board top-50 (A4 context) — CONTROL efea88e5 · PREVIOUS c8051893 · CURRENT 59b1927a
