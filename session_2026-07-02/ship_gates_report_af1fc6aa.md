# ship_gates_check report — STATE: CANDIDATE v2.2 concave-ramp + V0-floor (CURRENT, D12) — head af1fc6aa store 644d1254
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: CANDIDATE v2.2 concave-ramp + V0-floor (CURRENT, D12) ===
=== SHIP GATES BOARD — head af1fc6aa store 644d1254 — suite 764a0d91 — 2026-07-03 ===
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=8aed420a · PREVIOUS=c8051893 · CURRENT=af1fc6aa ===
...
A6        PASS    | PASS    | PASS     yr1-3 RUC median=449 (n=13, pooled — thin slice) vs pick-matched MID kernel median=558 (n=66, bw=0.6 log-pick, RATIFIED 02/07)
...
A11  [DC] PASS    | PASS    | PASS     Farrow>Patterson: 1644 vs 849; Cumming>Annable: 1948 vs 1414
A12  [DC] FAIL    | FAIL    | FAIL     Travaglia>Moraes: 712 vs 887; Smillie>Retschko: 779 vs 730
          triage: [DC] gate — attribute ENGINE- vs DATA-caused BEFORE this blocks (SHIP_GATES PROCESS)
...
B4        FAIL    | FAIL    | FAIL     regenerated rl_app_data.json md5=af68d2f8 vs shipped b8f9e998 (byte-agree gate; export exit=0)
B5        FAIL    | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 52 saves, aggregate lift +1330; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)  <- MOVED
B6        FAIL    | PASS    | PASS     ramp(0..14g)=[1139, 1469, 1785, 2482, 3103, 3190, 3238, 3291, 3305, 3314, 3367, 3435, 3523, 3563, 3592]; dips(more games worth less)=none; 0->6 rise T=+2099; 0->6 steps>50%T=none; rise by 3g=+1343 (need >=525) [whole-ramp re-spec, DECLARED thresholds]  <- MOVED
...
VERDICT: FAIL=4  FEATURE=1  NOT-RUN=1  PASS=11  PENDING=5  STRUCK=1  (132s)
```
...
B5 FLOOR-SAVES table (n=52, aggregate lift=+1330 — printed every gates-board run, the new alarm surface):
| player | club | yrs-in-system | raw ev | floor | saved-to | lift | register status |
|---|---|---|---|---|---|---|---|
| Paddy Dow | Carlton | 9 | 13 | 112.4 | 105 | +92 | clear |
| Jack Martin | Gold Coast | 14 | 44 | 112.4 | 129 | +85 | clear |
| Jaeger O'Meara | Gold Coast | 15 | 62 | 150.0 | 136 | +74 | clear |
| Steele Sidebottom | Collingwood | 18 | 3 | 69.0 | 77 | +74 | clear |
| Chayce Jones | Adelaide | 8 | 9 | 80.2 | 81 | +72 | clear |
| Luke Pedlar | Adelaide | 6 | 66 | 124.2 | 132 | +66 | clear |
| Conor Stone | GWS | 6 | 25 | 96.7 | 77 | +52 | clear |
| Jacob Hopper | GWS | 11 | 42 | 89.7 | 93 | +51 | clear |
| Phoenix Gothard | GWS | 3 | 368 | 355.3 | 412 | +44 | clear |
| Oliver Wiltshire | Geelong | 3 | 13 | 86.2 | 54 | +41 | clear |
| Jade Gresham | St Kilda | 11 | 13 | 43.0 | 50 | +37 | clear |
| Bailey Laurie | Melbourne | 6 | 21 | 55.6 | 55 | +34 | clear |
| Callum Ah Chee | Gold Coast | 11 | 38 | 85.2 | 72 | +34 | clear |
| Liam Stocker | Carlton | 8 | 2 | 39.8 | 35 | +33 | clear |
| Jake Melksham | Essendon | 17 | 11 | 74.5 | 44 | +33 | clear |
