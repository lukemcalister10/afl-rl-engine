# ship_gates_check report — STATE: PROTOTYPE/UNREGISTERED @ bea8fea8 — NOT AN ENDORSED STATE — head bea8fea8 store 968de0c7 config c2d233aec104
_Three-column rule (Luke, binding D10): every board output reports CONTROL / PREVIOUS / CURRENT with explicit deltas._
```
=== STATE: PROTOTYPE/UNREGISTERED @ bea8fea8 — NOT AN ENDORSED STATE ===
=== SHIP GATES BOARD — head bea8fea8 store 968de0c7 config c2d233aec104 — suite 764a0d91 — 2026-07-17 ===
...
=== THREE-COLUMN RULE (Luke, binding D10): CONTROL=7a07e369 · PREVIOUS=efea88e5 · CURRENT=bea8fea8 ===
...
A6        PASS    | PASS    | PASS     yr1-3 RUC median=473 (n=11, pooled — thin slice) vs pick-matched MID kernel median=901 (n=73, bw=0.6 log-pick, RATIFIED 02/07)
...
B1        PASS    | PASS    | PASS     JULY-8 construction (owner-ruled 2026-07-13, register v52 — CONFORMED; raw class-year sums of Vpath averaged UNWEIGHTED across 17 classes 2004-2020 incurve ND+RD; CANDIDATE regenerated this run — engine bea8fea8 store 968de0c7 config c2d233aec104): y1=71436.8 y2=82135.8 y3=85494.2 y4=90665.4 y5=91068.9 y6=87967.5 y7=79977.4; den=min(y1,y2)=y1=71436.8; ratios y4=1.2692(above-guide) y5=1.2748(above-guide) y6=1.2314(in-guide); hard<=1.30 -> PASS x3; guide 1.20-1.25 ADVISORY (margin reported, never gates)
B2        PASS    | PASS    | PASS     leave-cohort-out sensitivity (2014-2018 ND held out): median |IS-WF| leakage=0.000 %-pts (FULL precision; tol 0.5 UNCHANGED, SET 02/07/2026); worst cells RUC|GOOD|T5:5.28, GEN_DEF|GOOD|T4:4.84, KEY_DEF|GOOD|T3:4.49, GEN_DEF|GOOD|T5:3.62; GOOD>BUST sep GEN_DEF 41.0/1.0, GEN_FWD 39.7/0.6, KEY_DEF 48.4/1.1, KEY_FWD 61.8/0.6, MID 50.0/0.5, RUC 26.3/0.4 [cert engine bea8fea8 store 968de0c7 config c2d233ae]
B3        PASS    | PASS    | DIFFERS-BY-DESIGN CANDIDATE book stable seal (regenerated this run — engine bea8fea8 store 968de0c7 config c2d233aec104): candidate head bea8fea8 != sealed head a83c9f6d — new version; the v2.6 book must be RE-SEALED at the bake (owner action). current=1a3a4de1a0e94dd5.. (2649 players) vs baseline=ef2fbf9caf2ef63e.. (2649 players, sealed head a83c9f6d) [full stable-keyed content seal; raw-file sha is id(p)-keyed / non-deterministic by design]  <- MOVED
B4        PASS    | PASS    | FAIL     regenerated rl_app_data.json md5=9829d01a vs shipped ee70335a (byte-agree gate; export exit=0)  <- MOVED
B5        FEATURE | FEATURE | FEATURE  floor-as-pricing-feature (Luke-ruled 02/07; VARIANT A flat .05 tail): 60 saves, aggregate lift +2065; pure lower bound: lowered=0 (bar 0), non-ND moved=0 (bar 0); saves table printed below (the new alarm surface)
...
VERDICT: DIFFERS-BY-DESIGN=1  FAIL=5  FEATURE=1  PASS=14  PENDING=4  STRUCK=1  (454s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 129 | 166 | 165 | 177 | 157 | 144 |
| 2005 | 4 | 100 | 151 | 142 | 190 | 178 | 177 | 155 |
| 2006 | 6 | 100 | 118 | 124 | 136 | 139 | 139 | 123 |
| 2007 | 5 | 100 | 119 | 108 | 110 | 138 | 131 | 110 |
| 2008 | 4 | 100 | 118 | 148 | 159 | 142 | 125 | 115 |
| 2009 | 2 | 100 | 112 | 96 | 95 | 97 | 89 | 80 |
| 2010 | 5 | 100 | 118 | 122 | 133 | 135 | 118 | 97 |
| 2011 | 4 | 100 | 116 | 129 | 140 | 139 | 137 | 120 |
| 2012 | 4 | 100 | 101 | 109 | 110 | 103 | 106 | 89 |
| 2013 | 5 | 100 | 119 | 131 | 150 | 156 | 142 | 113 |
| 2014 | 4 | 100 | 114 | 122 | 124 | 111 | 121 | 116 |
| 2015 | 2 | 100 | 107 | 105 | 103 | 102 | 106 | 105 |
| 2016 | 4 | 100 | 117 | 132 | 150 | 141 | 144 | 126 |
| 2017 | 3 | 100 | 111 | 113 | 103 | 101 | 102 | 98 |
| 2018 | 2 | 100 | 115 | 103 | 111 | 111 | 108 | 102 |
| 2019 | 5 | 100 | 99 | 103 | 109 | 123 | 117 | 99 |
| 2020 | 1 | 100 | 99 | 95 | 89 | 97 | 97 | — |
| _indexed AVG (SHAPE DIAGNOSTIC — DEMOTED 2026-07-13, NOT the gate)_ | _5_ | _100_ | _116_ | _120_ | _128_ | _129_ | _124_ | _112_ |
| **July-8 raw-sum AVG (THE GATED ROW)** | **—** | **71437** | **82136** | **85494** | **90665** | **91069** | **87967** | **79977** |

B5 FLOOR-SAVES table (n=60, aggregate lift=+2065 — printed every gates-board run, the new alarm surface):
| player | club | yrs-in-system | raw ev | floor | saved-to | lift | register status |
|---|---|---|---|---|---|---|---|
| Paddy Dow | — | 9 | 16 | 140.8 | 174 | +158 | clear |
| Jaeger O'Meara | — | 15 | 62 | 150.0 | 204 | +142 | clear |
| Chayce Jones | — | 8 | 14 | 85.4 | 119 | +105 | clear |
| Steele Sidebottom | — | 18 | 3 | 81.2 | 107 | +104 | clear |
| Oliver Wiltshire | — | 3 | 14 | 98.3 | 107 | +93 | clear |
| Stephen Coniglio | — | 15 | 91 | 140.8 | 174 | +83 | clear |
| Harvey Gallagher | — | 4 | 77 | 153.3 | 142 | +65 | clear |
| Luke Pedlar | — | 6 | 85 | 146.2 | 149 | +64 | clear |
| Bailey Laurie | — | 6 | 20 | 87.8 | 76 | +56 | clear |
| Conor Stone | — | 6 | 36 | 114.1 | 90 | +54 | clear |
| Jack Martin | — | 14 | 47 | 140.8 | 101 | +54 | clear |
| Billy Cootee | — | 1 | 45 | 305.6 | 94 | +49 | clear |
| Callum Ah Chee | — | 11 | 39 | 87.0 | 88 | +49 | clear |
| Phoenix Gothard | — | 3 | 386 | 443.2 | 432 | +46 | clear |
| Jacob Hopper | — | 11 | 88 | 87.0 | 130 | +42 | clear |
...
| Laitham Vandermeer | — | 8 | 1 | 37.2 | 34 | +33 | clear |
| Judson Clarke | — | 5 | 64 | 106.9 | 95 | +31 | clear |
...
| Finlay Macrae | — | 6 | 92 | 101.3 | 115 | +23 | clear |
...
| Lachlan Weller | — | 12 | 67 | 67.8 | 87 | +20 | clear |
| Jacob Wehr | — | 6 | 4 | 31.6 | 22 | +18 | clear |
| Daniel Butler | — | 12 | 3 | 17.2 | 21 | +18 | clear |
| Oliver Henry | — | 6 | 79 | 108.2 | 96 | +17 | clear |
...
| Hunter Clark | — | 9 | 47 | 87.0 | 58 | +11 | clear |
| Jackson Archer | — | 5 | 69 | 46.8 | 79 | +10 | clear |
| Jamie Cripps | — | 16 | 26 | 41.1 | 36 | +10 | clear |
| Bailey Macdonald | — | 4 | 119 | 94.9 | 128 | +9 | clear |
| Harry Schoenberg | — | 7 | 52 | 47.1 | 59 | +7 | clear |
| Callum Coleman-Jones | — | 9 | 37 | 56.3 | 44 | +7 | clear |
| Liam Ryan | — | 9 | 25 | 45.0 | 31 | +6 | clear |
| Luke McDonald | — | 13 | 52 | 87.0 | 56 | +4 | clear |
| Nicholas Coffield | — | 9 | 53 | 87.0 | 56 | +3 | clear |
| Nathan Broad | — | 11 | 9 | 17.2 | 12 | +3 | clear |
| Harvey Harrison | — | 5 | 62 | 56.4 | 63 | +1 | clear |
| Mitch McGovern | — | 12 | 28 | 32.8 | 29 | +1 | clear |

## Board top-50 (A4 context) — CONTROL 7a07e369 · PREVIOUS efea88e5 · CURRENT bea8fea8
