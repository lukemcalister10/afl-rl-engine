# ship_gates_check report — head efc15c6c store 644d1254
```
=== SHIP GATES BOARD — head efc15c6c store 644d1254 — suite 764a0d91 — 2026-07-02 ===
A1        PASS     Duursma>Uwland: 4179 vs 1781
A2        FAIL     Curtis>=0.90xWard: 1162 vs 1604 (Ward=1782, ratio=0.652) [AMENDED 02/07/2026; UNCHANGED at 0.90 by ruling D7 — Luke: "we can look at Curtis down the line"]; Weddle>Ward: 1628 vs 1782
A3   [DC] FAIL     Connor Rozee: 2026=2679 2025=3874 ratio=0.69 (need >=0.75) [evaluated PRE-LTI-layer — Luke 02/07; AMENDED 0.80->0.75 Luke D7 data-caused (out for 2026), knife-edge by design]
...
A6        PASS     yr1-3 RUC median=314 (n=13, pooled — thin slice) vs pick-matched MID kernel median=521 (n=66, bw=0.6 log-pick, RATIFIED 02/07)
...
B1        PASS     cross-cohort AVERAGE peak N=4 AVG(peak)=169 (need peak in yrs 4-6, >100; pre-peak dips of the AVERAGE <5% tolerated, path_ok=True; per-cohort UNGATED, table printed every run — Luke redefinition 02/07 D5); avg row: 1:100 2:132 3:157 4:169 5:161 6:149 7:131; cohorts n=17; matrix=s4_matrix_gradedfix_efc15c6c.json
B2        NOT-RUN  run _gate1_wf.py first (writes /home/claude/gate1_out.txt)
...
B4        FAIL     regenerated rl_app_data.json md5=1d1a7975 vs shipped b8f9e998 (byte-agree gate; export exit=0)
B5        FEATURE-ABSENT floor feature not wired at this head (v2 candidate carries it); legacy offender count = 45 (INFORMATIONAL — the alarm is retired, Luke-ruled 02/07 D7)
...
VERDICT: FAIL=7  FEATURE-ABSENT=1  NOT-RUN=1  PASS=8  PENDING=5  STRUCK=1  (109s)
```
...
|---|---|---|---|---|---|---|---|---|
| 2004 | 5 | 100 | 139 | 190 | 187 | 191 | 168 | 146 |
| 2005 | 4 | 100 | 145 | 175 | 215 | 186 | 186 | 163 |
| 2006 | 4 | 100 | 142 | 174 | 191 | 184 | 173 | 148 |
| 2007 | 5 | 100 | 133 | 139 | 146 | 167 | 160 | 135 |
| 2008 | 4 | 100 | 134 | 186 | 206 | 179 | 159 | 139 |
| 2009 | 4 | 100 | 122 | 115 | 132 | 118 | 104 | 92 |
| 2010 | 4 | 100 | 143 | 166 | 187 | 171 | 156 | 130 |
| 2011 | 4 | 100 | 136 | 171 | 201 | 190 | 174 | 142 |
| 2012 | 4 | 100 | 123 | 142 | 147 | 136 | 128 | 106 |
| 2013 | 4 | 100 | 137 | 169 | 197 | 194 | 167 | 129 |
| 2014 | 4 | 100 | 134 | 163 | 178 | 160 | 152 | 145 |
| 2015 | 4 | 100 | 126 | 144 | 148 | 138 | 138 | 123 |
| 2016 | 4 | 100 | 138 | 170 | 192 | 177 | 177 | 152 |
| 2017 | 3 | 100 | 119 | 131 | 121 | 112 | 106 | 98 |
| 2018 | 3 | 100 | 126 | 152 | 147 | 147 | 128 | 118 |
| 2019 | 4 | 100 | 132 | 157 | 173 | 172 | 152 | 135 |
| 2020 | 3 | 100 | 112 | 130 | 114 | 110 | 110 | — |
| **AVG (the gated row)** | **4** | **100** | **132** | **157** | **169** | **161** | **149** | **131** |
