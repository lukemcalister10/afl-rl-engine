...
print(f"TEST 4 — M1+v7 x Rozee: ev25={ev(p,2025)} ev26={ev(p,2026)}  (baseline 3874 -> 2679)")
print("  -> does M1+v7 compress his legit 2025 peak (compound underpricing) or leave it?")
