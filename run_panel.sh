...
PANEL=[('Nick Daicos',7626),('Marcus Bontempelli',3524),('Harry Sheezel',7734),('Max Gawn',2413),('Harley Reid',3549),('Josh Ward',1650),('Darcy Moore',198),('Taylor Goad',785),('Josh Smillie',1189),('Will Green',571)]   # CANDIDATE W4+L1c rectification 2026-07-08 (store e1b4d8bf UNCHANGED) — NOT BAKED; movers vs the 2026-07-06 W4 panel ARE the L1c young-lever replacement at RL_YCRED_W=0.7 (Reid 3592->3549 = old runway credit removed, his 53g burn the evidence fade; Goad 801->785 RUC sat cell ~0 re-rating; Smillie 1015->1189 sat-out MID pk7 credit; Green 563->571); baked v2.5 panel was: Daicos 7002 Bont 3084 Sheezel 7151 Gawn 2112 Reid 3549 Ward 1650 Moore 198 Goad 723 Smillie 974 Green 536; ALL-LEVERS-OFF reproduces the baked panel byte-exact (RL_FWDRECAL=0 RL_YOUNG=0 RL_OVPX=0 RL_KPFFIX=0 RL_V7FORM=0 RL_W4_RUC=0 RL_FORMDECL=0 RL_PVCFIT=0 — re-verified this session on the L1c head)
