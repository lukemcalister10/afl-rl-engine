...
PANEL=[('Nick Daicos',8050),('Marcus Bontempelli',3721),('Harry Sheezel',8116),('Max Gawn',2538),('Harley Reid',3726),('Josh Ward',1746),('Darcy Moore',209),('Taylor Goad',818),('Josh Smillie',1302),('Will Green',588)]   # ID-MIGRATION clean-scope candidate (engine 7a07e369 store b0c39d78 config 69ead79b944d board de4baef9). RE-PINNED from v2.8: Sheezel 8115->8116 + Smillie 1301->1302 moved +1 within the owner-declared taylor-adams retirement hairline ripple (<=+/-2 SCAR on 88 rows); the other 8 unchanged. Prior v2.8 (chapter-lever L1 young-GDEF transition credit + pick redenomination; store 04f38dad board 9ecbe0fa). RE-PINNED at the v2.8 bake to the reproduced candidate board (== ship_gates B4 board 9ecbe0fa, deterministic across repeat runs; == SWEEP_DISCOUNT 15% shipped column: Bont 3721 / Gawn 2538). Supersedes the ORPHAN W4+L1c stamp (store e1b4d8bf, never baked) that the chapter-lever candidate left un-updated. Prior baked panels: v2.5 Daicos 7002 Bont 3084 Gawn 2112 (engine efea88e5 store e1b4d8bf); the +5.24% pick redenomination + L1 GDEF credit account for the lift (L1 does not touch these 10 named — GEN_DEF-only). ALL-LEVERS-OFF still reproduces the v2.5 baked panel byte-exact (RL_FWDRECAL=0 RL_YOUNG=0 RL_OVPX=0 RL_KPFFIX=0 RL_V7FORM=0 RL_W4_RUC=0 RL_FORMDECL=0 RL_PVCFIT=0).
