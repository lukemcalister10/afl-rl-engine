# 00_MANIFEST — v4.21 · 2026-07-15 · supersedes v4.20
...
| **CORE** | **v2.8** | 0 | in full — BINDING. R98.9/R98.10/R100.10 IN; SSI move closed; P1 seam-pack slim at v2.8. |
| **HANDOVER** | **rev139** | 0 | state at the Fable → Fable rotation seam (2026-07-15; P1/P3 folded). |
...
| **CONSTRAINTS** | **v1.13** | 1 | **REPO-ONLY (P1, owner-ruled 2026-07-15)** — fetch + grep ONLY when judging a board. L-CAPTAIN + L-SMOOTH filed; ITEM-74 blocker REWRITTEN (PART 7). |
| **acceptance_v1_13.json** | **v1.13** | 1 | **REPO-ONLY (P1)** — assert the needed JSON entries by targeted extraction when judging a board |
