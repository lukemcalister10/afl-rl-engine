# CORE — AFL SuperCoach RL engine — v2.6 · 2026-07-15 · supersedes v2.5
...
### (3) SSI LOCATION: still at repo ROOT; the move into docs/ is QUEUED ON THE OWNER'S EXPLICIT WORD —
###     the root-file deletion sits outside the pen's docs/-only fence (item 85's crossing was a
###     declared one-off, never precedent).
