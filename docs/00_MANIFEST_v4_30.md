# 00_MANIFEST — v4.30 · 2026-07-16 · supersedes v4.29
...
|---|---|---|---|
| **00_MANIFEST** | **v4.30** | 0 | first, always |
| **CORE** | **v2.8** | 0 | in full — BINDING. |
| **HANDOVER** | **rev143** | 0 | THE POST-BAKE SEAM handover — the merged PVC+FLEX chapter's whole queue. |
| **DECISIONS** | **v106** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
| **OPEN_ITEMS_REGISTER** | read its OWN header | 1 | THE DURABLE LOG (v155+). Repo-only. |
| **CONSTRAINTS** | **v1.17** | 1 | REPO-ONLY (P1) — fetch + grep when judging a board. **G-COHORT hard 1.30** · **L-AXIS BINDING (ratified 2026-07-16)**. |
