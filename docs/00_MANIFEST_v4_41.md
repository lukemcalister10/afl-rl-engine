# 00_MANIFEST — v4.41 · 2026-07-16 · supersedes v4.40
### v4.41 (seat 9's pen, THE ROTATION FILING — item 250): **SEAT 9 CLOSES; seat 10 opens on
### HANDOVER → rev148** (Leg B CLOSED at four iterations by R105.6 "Accept": fade 0.25 + bar 0.80
### both OWNER-SET; zero seat-authored numbers remain; SEGMENT 5 in flight — its mini-checkpoint is
### seat 10's first act). **DECISIONS → v115** (R105.6 folded; open words NONE). **acceptance →
### v1.20** (decay/threshold owner-provenance · λ pre-gate removed · L-RECENCY + the all-804 ledger
### carried). **memo → v1.3** (seals: memo cf6c0080 · acceptance 6b83e336 == the segment-5 FEED).
### Register → v223 (item 250). Revoke the seat-9 token at this seam.
### v4.40 (seat 9's pen, PACK REVIEW №3 — item 242): **R105.4 WEIGHT-DON'T-GATE + R105.5 L-RECENCY
### folded into DECISIONS → v114** (they were register-only — the rulings doc had fallen behind).
### **HANDOVER → rev147** (diagnostic RETURNED/prescreened · memo v1.2 IS the law · SEGMENT 4 FIRED
### · open owner words: NONE until the return). **acceptance → v1.19** (the table row was stale at
### v1.18). Seals verified live (memo 1ff0702a · acceptance 7a97717b == the segment-4 directive).
### Register → v215 (item 242). Nothing else moved.
### v4.39 (seat 9's pen, THE OWNER'S PACK REVIEW — item 238): **HANDOVER → rev146** (seg-3 RETIRED
### at 243106b, prescreen PASS item 237; ONE chat in flight — the qualifying diagnostic; segment-4
### base pinned; the counter-calibration conduct line). **DECISIONS → v113** (to-do refs only).
### HOUSEKEEPING: rev144/rev145 + DECISIONS v111/v112 + 8 COMPLETED directives archived (the live
### docs/ folder now carries only live work). Register → v211 (item 238). Nothing else moved.
...
|---|---|---|---|
| **00_MANIFEST** | **v4.41** | 0 | first, always |
| **CORE** | **v2.8** | 0 | in full — BINDING. |
| **HANDOVER** | **rev148** | 0 | THE ROTATION DOC — Leg B CLOSED (four iterations) · SEGMENT 5 in flight (mini-checkpoint = seat 10 act 1) · the queue to the ONE chapter-end bake · standing conduct. |
| **DECISIONS** | **v115** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
...
| **acceptance_v1_20.json** | **v1.20** | 1 | REPO-ONLY (P1) — leg_b rho (d=0.25 OWNER-SET) · bar 0.80 OWNER-SET · recency_invariant · movement_ledger · `standing_fails` · `audit_rule`. |
