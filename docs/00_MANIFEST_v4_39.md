# 00_MANIFEST — v4.39 · 2026-07-16 · supersedes v4.38
...
|---|---|---|---|
| **00_MANIFEST** | **v4.39** | 0 | first, always |
| **CORE** | **v2.8** | 0 | in full — BINDING. |
| **HANDOVER** | **rev146** | 0 | PRE-ROTATION — the Leg-B three-iteration story · ONE chat in flight · the queue to v2.11 · standing conduct. |
| **DECISIONS** | **v113** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
