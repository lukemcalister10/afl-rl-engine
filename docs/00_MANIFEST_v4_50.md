# 00_MANIFEST — v4.50 · 2026-07-17 · supersedes v4.49
...
|---|---|---|---|
| **00_MANIFEST** | **v4.50** | 0 | first, always |
...
## STATE AT v4.50 (THE SEAT-11 ROTATION SEAM)
...
- **LEG C CONTENT-COMPLETE.** THEN: the v1.4 review → the re-seal → Leg D (groundwork feed @
  `9845180`) → Leg E → the ladder → ONE bake → **v2.11**.
- **TOOLS ON MAIN:** first_commands.sh + the prescreen proof-hook · viewing_pack.py (owner-merged
  PRs #106/#107).
- Seat 11 CLOSED (correction ledger ×3, owned). Owner at this seam: PK sync · the seat-12 token +
  revoke seat-11's · the dead-branch delete.
