#!/bin/bash
# ORDER C — the walk-forward per-entrant emit (RL_O34=1; the 31-F emitter byte-carried). The ORDER 31-F emitter
...
export RL_O31=1 RL_O32=1 RL_O34=1
export RL_DAY0_FINAL="$HERE/DAY0_C_FINAL.json"
...
cp "$OUT/emit.log" "$HERE/EMIT_O34FINAL_out.txt" 2>/dev/null
