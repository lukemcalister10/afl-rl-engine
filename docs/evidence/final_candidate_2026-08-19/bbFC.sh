#!/bin/bash
# FINAL-CANDIDATE board build. BYTE COPY of the D6 seat's bbD6.sh with ONLY the scratch default
# re-pointed at this seat's own dir. No other change. ORIGINAL D6 HEADER FOLLOWS.
...
SP=${RL_SCRATCH:-/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/fc}
TAG=${1:-x}
WS=$SP/bb_$TAG
rm -rf "$WS"; mkdir -p "$WS"
...
for V in RL_O31 RL_O32 RL_O35 RL_O36 RL_O36_LAM_S1 RL_O36_TALL RL_O36_FLOORFIX \
         ...
         RL_O41_SDOFF RL_O41_CREDIT RL_O41_CREDITFORM RL_O41_RESET RL_O41_INJ RL_O41_R3 RL_O41_RAMP RL_O41_BREAK RL_O41_UNWIND RL_O42 RL_AVAIL; do
