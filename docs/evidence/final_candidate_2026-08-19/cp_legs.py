#!/usr/bin/env python3
"""COMPLETION PASS — THE MECHANISM LEGS, on the PARITY BOARD a05fe951. fc_legs.py carried with
RL_O43=1 added to the dial line and the output renamed; the p15 correction that file made to the
inherited as_legs.py is carried forward unchanged.
...
D = dict(RL_O37='1', RL_O38A='1', RL_O38B1='1', RL_O39_BETASAT='0.105',
         ...
         RL_O41_RAMP='1', RL_O41_BREAK='unwind', RL_O41_UNWIND='7', RL_O42='1', RL_O43='1')
...
json.dump(out, open(os.path.join(HERE, 'LEGS_CP.json'), 'w'), indent=1, sort_keys=True)
print()
print('rows with legs: %d   (production leg captured on %d)' % (len(rows), len(seen)))
print('written: LEGS_CP.json')
