#!/bin/bash
# FINAL-CANDIDATE — the walk-forward per-entrant emit. The D6 seat's run_emit_D6.sh, committed
# unrun by that seat, RUN HERE. Only the staging dir is re-pointed at this seat's scratch; the
# dial pass-through (which already carries RL_O41_RAMP/BREAK/UNWIND + RL_O42) is untouched.
# ORIGINAL D6 HEADER FOLLOWS.
...
set -uo pipefail
LABEL=${OP_LABEL:-ASMCAND}
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO="$(cd "$HERE/../../.." && pwd)"
SP=/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad
OUT=$SP/fc/emit_$LABEL
...
for V in RL_O35 RL_O36 RL_O37 RL_O38A RL_O38B1 RL_O38B2 RL_O39_TMAXPCT RL_O39_BETASAT RL_O36_LAM_S1 RL_O36_TALL RL_O36_FLOORFIX RL_O36_KAPPA RL_O36_GAMMA \
         ...
         RL_O41_SDOFF RL_O41_CREDIT RL_O41_CREDITFORM RL_O41_RESET RL_O41_INJ RL_O41_R3 RL_O41_RAMP RL_O41_BREAK RL_O41_UNWIND RL_O42; do
