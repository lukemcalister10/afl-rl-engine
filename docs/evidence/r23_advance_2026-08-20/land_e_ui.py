#!/usr/bin/env python3
"""ACT 1 (THE SHEET RE-CUT), LANDING STEP E — THE UI BUNDLES. BOTH WRITERS. THIS IS THE THRICE-PROVEN TRAP.
...
spec=importlib.util.spec_from_file_location('rm_r23recut',P('engine','rl_after','ingestion','round_movers.py'))
rm=importlib.util.module_from_spec(spec); sys.modules['rm_r23recut']=rm; spec.loader.exec_module(rm)
