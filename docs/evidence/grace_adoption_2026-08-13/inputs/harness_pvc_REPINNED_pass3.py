...
RE-POINTED 2026-08-11 for the #334 COMPOSITION ACT's canonical-instrument read, one disclosed act.
...
EXPECT_STORE = 'd9a24282'        # RE-POINTED 2026-08-11 (#334 composition act): the current gate store, 37ced3ce -> d9a24282. Assert byte-identical; only the pinned value moved.
EXPECT_V0SURF = '6ef67f07db98'   # RE-POINTED 2026-08-11 (#334 composition act): the frozen surface these emits carry, 3e8e50de5103 -> 6ef67f07db98. PRIOR NOTE, kept: RE-POINTED 2026-08-07 (#334 stage B stage 3): the DECLARED surface refit around the settled ladder moved the year-zero surface signature af556bdca53d -> 3e8e50de5103. The assert is byte-identical; only the pinned value moved.
                                 # NB: does NOT discriminate fb9efdec from b540833b — see the F-C block above
EXPECT_N = 1197                     # ND teaching rows after the class cut — RE-MEASURED 2026-08-06, not assumed
CLASS_CUT = 2022
K_FOLDS = 5
FOLD_SEED = 20260730
MIN_STRATUM = 20
