...
H.append('<div class="brk"><h2>THE ANSWER, BEFORE ANY TABLE</h2>'
         ...
         'at zero breaks your +14% band rail. The coolest one inside the grid still reads picks 1-10 '
         'at +22.40%, and going OUTSIDE the grid &mdash; the counterweight switched off entirely '
         '&mdash; only gets it to +18.30%. Even with the age bar off as well.</li></ul>'
