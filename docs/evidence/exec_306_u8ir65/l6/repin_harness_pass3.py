#!/usr/bin/env python3
"""#306 L6 PASS 3 — RE-PIN `harness_pvc_REPINNED.py`, with its in-file ledger, as ONE act.
...
OLD_SIG = 'f802734d5406'
NEW_SIG = '1cbbd9b00ff4'        # from this pass's refit log: shipped-config signature
OLD_SURF = '69571649'
NEW_SURF = 'b683e2ec'
ANCHOR = 'RE-PINNED 2026-08-05 by #306 L6 PASS 2,'

LEDGER = """RE-PINNED 2026-08-05 by #306 L6 PASS 3, one disclosed act under the seam's authorisation
...
assert out.count(ANCHOR) == 1, 'the pass-2 entry must survive exactly once, below the new one'

const_old = "EXPECT_V0SURF = '%s'   # re-pinned 2026-08-05 (#306 L6 PASS 2, curve b61c01b0)" % OLD_SIG
assert out.count(const_old) == 1, 'could not anchor the constant line'
const_new = ("EXPECT_V0SURF = '%s'   # re-pinned 2026-08-05 (#306 L6 PASS 3, curve 3f5875b5)" % NEW_SIG)
