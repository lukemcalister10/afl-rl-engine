#!/usr/bin/env python3
"""#306 L6 CLOSURE — THE L1(b) ENUMERATED SAME-COMMIT INSTALL, executed as ONE ATOMIC ACT.
...
pass-specific constants move, and each one is listed here so the diff against pass 1 is readable:
    ...
    derived curve source   pass0_derived_curve1.json  ->  ../exec_306_u8ir65/l6/pass3_derived_curve4.json
...
AUTHORISED = '01f27f0231929b285de83aaa6713048d'      # THE CLOSURE RULING, seam 5188042722 (owner word 2026-08-05)
PRE_CURVE = '3f5875b5'                                # what must be installed before this act
OLD_HEAD_STR = '3014.1435'                            # the CURRENT head — the sealed twin token
OLD_PE = 'b6bacff2'                                   # the per_entrant stamp this act replaces
SRC_SURFACE = 'b683e2ec'                              # the surface the new curve was derived from
...
DERIV = P('docs/evidence/exec_306_u8ir65/l6/pass3_derived_curve4.json')
...
NEW_PE_MD5 = md5f(P('docs/evidence/exec_306_u8ir65/l6/pass3_matrix.json'))[:8]
assert NEW_PE_MD5 == '557a53db', 'per_entrant stamp %s' % NEW_PE_MD5
...
c['numeraire']['_doc'] = (                                    # BY PATH — sealed twin, occurrence 2
    ...
    'CONSTRUCTION. Re-measured at #306 L6 closure on surface %s; the prior value was %s.'
...
c['derived_from'] = (
    ...
    '#306 L6 closure: the matrix emitted on the redesigned lens lane at installed curve %s, committed '
...
c['_working_substrate_note'] = (
    '#306 L6 CLOSURE: curve 2 (%s) installed as THE ADOPTED RULED CURVE under the CLOSURE RULING (seam 5188042722), derived '
...
u['_doc'] = ('#306 L6 closure working substrate: pick curve payload %s (ladder sum %d, pick64 %d), '
...
rc['pvc_provenance']['_note'] = ('#306 L6 closure: curve 2 installed as working substrate from surface '
...
BK = P('docs/evidence/exec_306_u8ir65/l6/_install_backup_closure')
