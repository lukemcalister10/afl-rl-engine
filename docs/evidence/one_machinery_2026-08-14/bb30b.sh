...
ROOT=${RL_ROOT:-/home/user/afl-rl-engine/.claude/worktrees/agent-ac6abd0494353e85f}
SP=${RL_SCRATCH:-/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o30b}
TAG=${1:-x}
GR=${2:-UNSET}
RLM=${3:-}
WS=$SP/bb_$TAG
