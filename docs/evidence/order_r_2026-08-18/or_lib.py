#!/usr/bin/env python3
"""ORDER R — the shared engine harness. ORDER Q's oq_lib.py with the two ORDER R dials added to
the environment clear-list so an unset R dial cannot leak in from a previous run. NOTHING ELSE IS
