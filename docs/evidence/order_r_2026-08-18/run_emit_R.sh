...
echo "  emit starting $(date -u +%H:%M:%S)  (RL_O37=${RL_O37:-unset} A=${RL_O38A:-unset} B1=${RL_O38B1:-unset} pct=${RL_O39_TMAXPCT:-unset} beta=${RL_O39_BETASAT:-unset})"
S=$(date +%s)
