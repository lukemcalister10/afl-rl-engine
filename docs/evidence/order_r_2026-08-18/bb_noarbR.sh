...
echo "instrument pins COMPUTED at run (disclosed copies, unmodified by ORDER R):"
...
cd "$N"
for L in OKRULED PBUILT QB1 QAB1 R15 R20 R15A R20A Rb1 Rb2 R15b1 R20b2 R20b2A; do
