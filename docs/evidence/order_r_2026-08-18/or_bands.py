#!/usr/bin/env python3
"""ORDER R — THE ND BAND TABLES, IN BOTH WINDOWS. ORDER R's oq_bands.py, REUSED WHOLE.
...
LABELS = [('OKRULED', 'ORDER K f3101883'),
          ('PBUILT', 'ORDER P 374d4e44 — THE BASE'),
          ('QB1', 'FIX B1 = p5 b0 A-off — the ORDER R control 1b1817f3'),
          ('QAB1', 'FIX A+B1 = p5 b0 A-on — the ORDER R control cbbb94d4'),
          ('R15', 'p15 b0     A off — the TMAX lever. PRICED, NOT ADOPTED'),
          ('R20', 'p20 b0     A off — the TMAX lever, far end. PRICED, NOT ADOPTED'),
          ('R15A', 'p15 b0     A ON  — the TMAX lever with FIX A. PRICED, NOT ADOPTED'),
          ('R20A', 'p20 b0     A ON  — the TMAX lever with FIX A, far end. PRICED, NOT ADOPTED'),
          ('Rb1', 'p5  0.111  A off — the BETA lever. PRICED, NOT ADOPTED'),
          ('Rb2', 'p5  0.105  A off — the BETA lever, near the CI floor. PRICED, NOT ADOPTED'),
          ('R15b1', 'p15 0.111  A off — both levers, middle. PRICED, NOT ADOPTED'),
          ('R20b2', 'p20 0.105  A off — both levers, SOFTEST. PRICED, NOT ADOPTED'),
          ('R20b2A', 'p20 0.105  A ON  — both levers softest + FIX A. PRICED, NOT ADOPTED')]
...
json.dump(OUT, open(os.path.join(HERE, 'BANDS_R.json'), 'w'), indent=1, default=float)
open(os.path.join(HERE, 'BANDS_R_out.txt'), 'w').write('\n'.join(L) + '\n')
print('\nwrote BANDS_R.json / BANDS_R_out.txt')
