#!/usr/bin/env python3
"""ORDER R — THE STANDING TWO-SIDED NO-ARB SUITE, in the owner's standing format.
...
LABELS = [l for l in ('OKRULED', 'PBUILT', 'QB1', 'QAB1', 'R15', 'R20', 'R15A', 'R20A',
                      'Rb1', 'Rb2', 'R15b1', 'R20b2', 'R20b2A')
...
NICE = {'OKRULED': 'ORDER K f3101883 — carries the DEFECTIVE blind eta charge',
        ...
        'QB1': 'FIX B1  p5  b0     A off — the settled repair, THE CONTROL 1b1817f3',
        'QAB1': 'FIX A+B1 p5 b0     A ON  — THE CONTROL cbbb94d4',
        'R15': 'ORDER R p15 b0     A off — the TMAX lever. PRICED, NOT ADOPTED',
        'R20': 'ORDER R p20 b0     A off — the TMAX lever, far end. PRICED, NOT ADOPTED',
        'R15A': 'ORDER R p15 b0     A ON  — the TMAX lever with FIX A. PRICED, NOT ADOPTED',
        'R20A': 'ORDER R p20 b0     A ON  — the TMAX lever with FIX A, far end. PRICED, NOT ADOPTED',
        'Rb1': 'ORDER R p5  0.111  A off — the BETA lever. PRICED, NOT ADOPTED',
        'Rb2': 'ORDER R p5  0.105  A off — the BETA lever, near the CI floor. PRICED, NOT ADOPTED',
        'R15b1': 'ORDER R p15 0.111  A off — both levers, middle. PRICED, NOT ADOPTED',
        'R20b2': 'ORDER R p20 0.105  A off — both levers, SOFTEST. PRICED, NOT ADOPTED',
        'R20b2A': 'ORDER R p20 0.105  A ON  — both levers softest + FIX A. PRICED, NOT ADOPTED'}
...
P('=' * 118)
P('ORDER R — STANDING TWO-SIDED NO-ARB SUITE. NOTHING IS ADOPTED.  carry charge = 14%/yr.')
...
json.dump(OUT, open(os.path.join(HERE, 'STANDING_TABLES_R.json'), 'w'), indent=1, default=float)
open(os.path.join(HERE, 'STANDING_TABLES_R_out.txt'), 'w').write('\n'.join(L) + '\n')
print('\nwrote STANDING_TABLES_R.json / STANDING_TABLES_R_out.txt')
