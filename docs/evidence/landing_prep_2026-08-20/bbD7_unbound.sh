...
# DELIBERATELY REMOVED for the unbound-surface probe (landing prep 2026-08-20, order item 2): the
# explicit binding is gone so the ENGINE OWN PRECEDENCE decides which v0surf the build loads.
unset RL_V0SURF_PKL
