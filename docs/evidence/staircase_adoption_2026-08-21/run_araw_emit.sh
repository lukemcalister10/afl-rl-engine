...
# with ONE declared change and nothing else: the label/dial pair is SFXARAW / RL_O44_LVLMONO=ratchet
# — VARIANT A RAW, THE ADOPTED ARM — instead of the two conserved arms it already ran.
#
...
source tools/build_lock.sh && build_lock_acquire sfx-araw-emit 7200 || exit 1
echo "### SFXARAW (ratchet = VARIANT A RAW, THE ADOPTED ARM) ###"
RL_O44_LVLMONO=ratchet SFX_LABEL=SFXARAW bash docs/evidence/staircase_fix_2026-08-20/run_emit_SFX.sh
build_lock_release
echo "### DONE ###"
