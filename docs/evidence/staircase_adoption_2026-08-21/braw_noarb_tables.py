# ==================================================================================================
# B-RAW CARRY. This file is docs/evidence/staircase_fix_2026-08-20/sfx_noarb_tables.py, byte-carried by
...
CANDS = ('SFXBRAW', 'SFXACON', 'SFXBCON')          # DECLARED CHANGE (2): the move block runs once per candidate
...
json.dump(OUT, open(os.path.join(HERE, 'STANDING_TABLES_NOARB_BRAW.json'), 'w'), indent=1, default=float)
open(os.path.join(HERE, 'STANDING_TABLES_NOARB_BRAW_out.txt'), 'w').write('\n'.join(L) + '\n')
P()
