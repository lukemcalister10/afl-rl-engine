# ==================================================================================================
# A-RAW CARRY. This file is docs/evidence/staircase_fix_2026-08-20/sfx_noarb_checks.py, byte-carried by
...
P('=' * 118)
open(os.path.join(HERE, 'NOARB_ARAW_CHECKS_out.txt'), 'w').write('\n'.join(L) + '\n')
