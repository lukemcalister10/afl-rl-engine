# ==================================================================================================
# B-RAW CARRY. This file is docs/evidence/staircase_fix_2026-08-20/sfx_noarb_page.py, byte-carried by
...
BD = json.load(open(os.path.join(HERE, 'BANDS_NOARB_BRAW.json')))['nd']
BDMETA = json.load(open(os.path.join(HERE, 'BANDS_NOARB_BRAW.json')))['meta']
...
CAND = os.environ.get('SFX_CAND', 'SFXBRAW')
BASE = 'SFXBASE'
...
OUTNAME = 'NOARB_BRAW_%s.html' % CAND
VKEY = 'ALLCOH'
