# ==================================================================================================
# A-RAW CARRY. This file is docs/evidence/staircase_fix_2026-08-20/sfx_noarb_bands.py, byte-carried by
...
json.dump(OUT, open(os.path.join(HERE, 'BANDS_NOARB_ARAW.json'), 'w'), indent=1, default=float)
open(os.path.join(HERE, 'BANDS_NOARB_ARAW_out.txt'), 'w').write('\n'.join(L) + '\n')
