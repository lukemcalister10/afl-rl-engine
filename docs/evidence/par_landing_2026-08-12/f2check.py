"""ORDER 20C — does the F2 book<->board parity gate break on the landed board?
...
for label, path in (('CONTROL board 94f1fec5', os.path.join(SP, 'board_CONTROL.json')),
                    ('LANDED  board 1dbd1480', os.path.join(ROOT, 'data/rl_build/rl_app_data.json'))):
