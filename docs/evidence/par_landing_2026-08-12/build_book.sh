#!/bin/bash
# ORDER 20C — RE-SEAL THE BOOK (s4_matrix.json) against the LANDED board, in a SCRATCHPAD COPY.
#
...
python3 "$SP/o20c/assert_pins_in_copy.py" "$WT" || { echo "PIN ASSERT FAILED"; exit 1; }
