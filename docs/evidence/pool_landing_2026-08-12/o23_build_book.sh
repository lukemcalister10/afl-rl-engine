#!/bin/bash
# ORDER 23 (carried verbatim from ORDER 20C) — RE-SEAL THE BOOK (s4_matrix.json) against the LANDED board, in a SCRATCHPAD COPY.
#
...
set -uo pipefail
OUTDIR="$1"
SRC=/home/user/afl-rl-engine/.claude/worktrees/agent-aca7a2be63ef974c9
...
python3 "/home/user/afl-rl-engine/.claude/worktrees/agent-aca7a2be63ef974c9/docs/evidence/pool_landing_2026-08-12/o23_assert_pins_in_copy.py" "$WT" || { echo "PIN ASSERT FAILED"; exit 1; }
