#!/usr/bin/env python3
"""ORDER 23 -- THE ITERATION TRAJECTORY (ND>64 UNCAPPED), printed honestly, every round.

  usage: o23_trajectory.py <out.json> <label> [<label> ...]
"""
import sys, json, os

IT = '/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o23/iter'
OUT = sys.argv[1]
LABS = sys.argv[2:]
