"""ORDER 23 (carried from ORDER 20C) — install the re-sealed book (built in a scratchpad copy, never in the checkout).
...
SRC = '/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o23/book'
