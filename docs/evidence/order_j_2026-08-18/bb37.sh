#!/bin/bash
# ORDER J board build (Order I bb36.sh with the counterweight knob overrides passed through). ORDER A's bb32.sh with ROOT re-pointed to this seat's worktree and RL_O36 /
...
ROOT=${RL_ROOT:-/home/user/afl-rl-engine/.claude/worktrees/agent-aeea615a333d342e0}
SP=${RL_SCRATCH:-/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o37}
TAG=${1:-x}
WS=$SP/bb_$TAG
rm -rf "$WS"; mkdir -p "$WS"
...
for V in RL_O36_KAPPA RL_O36_GAMMA RL_O36_ETA RL_O36_GAMMA_D RL_O36_LAMBDA; do
