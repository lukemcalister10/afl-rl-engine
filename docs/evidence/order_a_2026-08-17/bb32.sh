#!/bin/bash
# ORDER A / CANDIDATE 32 board build. ORDER 31-F's bb31f.sh with ROOT re-pointed to this seat's
...
ROOT=${RL_ROOT:-/home/user/afl-rl-engine/.claude/worktrees/agent-a9b412b92decdb5b8}
SP=${RL_SCRATCH:-/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o32}
TAG=${1:-x}
WS=$SP/bb_$TAG
rm -rf "$WS"; mkdir -p "$WS"
