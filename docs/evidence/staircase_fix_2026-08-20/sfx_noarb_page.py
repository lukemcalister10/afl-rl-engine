...
BD = json.load(open(os.path.join(HERE, 'BANDS_NOARB_SFX.json')))['nd']
BDMETA = json.load(open(os.path.join(HERE, 'BANDS_NOARB_SFX.json')))['meta']
...
CAND = os.environ.get('SFX_CAND', 'SFXACON')
BASE = 'SFXBASE'
...
OUTNAME = 'NOARB_SFX_%s.html' % CAND
VKEY = 'ALLCOH'
