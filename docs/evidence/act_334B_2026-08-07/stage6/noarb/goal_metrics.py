...
BOARD = json.load(open(os.path.join(HERE, '..', 'boards', 'board_rung%s_kpd0.json' % os.environ['RL_RUNG'])))
MATRIX = os.path.join(HERE, 'per_entrant_338_rung%s.json' % os.environ['RL_RUNG'])
