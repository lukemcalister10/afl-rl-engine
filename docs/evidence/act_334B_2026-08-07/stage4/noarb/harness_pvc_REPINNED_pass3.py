...
EXPECT_STORE = '37ced3ce'        # re-pointed 2026-08-06 (#338 no-arb reissue); the current gate store
EXPECT_V0SURF = '3e8e50de5103'   # RE-POINTED 2026-08-07 (#334 stage B stage 3): the DECLARED surface refit around the settled ladder moved the year-zero surface signature af556bdca53d -> 3e8e50de5103. The assert is byte-identical; only the pinned value moved.
