...
historical board id: forward_vector_68be10c7.json and the identity below are this round's.

Run:  python3 test_forward_lens_68be10c7.py      (exit 0 == the committed forward view matches this oracle)
"""
import hashlib
import json
import os
...
FORWARD_BOARD_MD5_GOOD = '68be10c79d0ee096455754e084bcf757'
FORWARD_REFERENCE = 'forward_vector_68be10c7.json'
...
def main():
    ...
    if fails:
        return 1
    print('FORWARD ORACLE OK: board 68be10c7 active 804 '
          '+1 sum 631180 sheezel 10856 | +2 sum 200752 sheezel 2611 '
          '| seal 9a3ac539 (expect 68be10c7/804/631180/200752/0)')
    return 0
