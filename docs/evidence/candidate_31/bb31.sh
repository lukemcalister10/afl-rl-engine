...
ROOT=${RL_ROOT:-/home/user/afl-rl-engine/.claude/worktrees/agent-a93c8eea9791414e2}
SP=${RL_SCRATCH:-/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o31}
TAG=${1:-x}
GR=${2:-UNSET}
RLM=${3:-}
WS=$SP/bb_$TAG
