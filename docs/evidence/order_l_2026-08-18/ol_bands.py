#!/usr/bin/env python3
"""ORDER L — THE ND BAND TABLES, IN BOTH WINDOWS, WITH AND WITHOUT THE 2005/06 COHORTS.
...
P('=' * 118)
P('ORDER L — ND BAND TABLES, BOTH WINDOWS, WITH AND WITHOUT THE 2005/06 COHORTS')
P('=' * 118)
...
json.dump(OUT, open(os.path.join(HERE, 'BANDS_L.json'), 'w'), indent=1, default=float)
open(os.path.join(HERE, 'BANDS_L_out.txt'), 'w').write('\n'.join(L) + '\n')
print('\nwrote BANDS_L.json / BANDS_L_out.txt')
