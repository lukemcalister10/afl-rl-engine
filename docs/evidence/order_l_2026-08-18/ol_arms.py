...
json.dump(OUT, open(os.path.join(HERE, 'ARMS_L.json'), 'w'), indent=1, default=float)
open(os.path.join(HERE, 'ARMS_L_out.txt'), 'w').write('\n'.join(L) + '\n')
print('\nwrote ARMS_L.json / ARMS_L_out.txt')
