#!/bin/bash
# ORDER 29B board build: ORDER 29's bb29.sh with ROOT re-pointed to this seat's worktree and the scratch
# directory renamed. NOTHING ELSE IS CHANGED -- same staging, same five-var thread pinning, same
# RL_V0SURF_PKL override for the /home/claude/v0surf.pkl shadowing hazard (packet 29 3.3), same env.
...
SP=/tmp/claude-0/-home-user-afl-rl-engine/7ac96fea-1199-5b6a-9d77-ded9f53694f7/scratchpad/o29b
TAG=${1:-x}
GR=${2:-UNSET}
RLM=${3:-}
WS=$SP/bb_$TAG
