...
assert meta['store_md5'][:8] == 'cb38ef11', "store pin moved: %s" % meta['store_md5']  # RE-POINTED 2026-08-13, ORDER 29 landing (was d9a24282)
assert meta['v0surf_sig'][:12] == '4405cba2b42f', "v0surf pin moved: %s" % meta['v0surf_sig']  # RE-POINTED 2026-08-13, ORDER 29 landing (was 6ef67f07db98)
