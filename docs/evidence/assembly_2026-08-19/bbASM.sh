#!/bin/bash
# ORDER S board build. ORDER R's bbR.sh with the FIVE RL_O40_* dials added to the pass-through
...
for V in RL_O31 RL_O32 RL_O35 RL_O36 RL_O36_LAM_S1 RL_O36_TALL RL_O36_FLOORFIX \
         ...
         RL_O41_SDOFF RL_O41_CREDIT RL_O41_CREDITFORM RL_O41_RESET RL_O41_INJ RL_O41_R3 RL_O41_RAMP RL_O41_BREAK RL_O41_UNWIND; do
