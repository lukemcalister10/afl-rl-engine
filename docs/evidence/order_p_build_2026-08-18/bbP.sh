#!/bin/bash
# ORDER P BUILD board build. ORDER K's bbK.sh with RL_O37 added to the pass-through list and the
...
for V in RL_O31 RL_O32 RL_O35 RL_O36 RL_O36_LAM_S1 RL_O36_TALL RL_O36_FLOORFIX \
         RL_O36_KAPPA RL_O36_GAMMA RL_O36_ETA RL_O36_GAMMA_D RL_O36_LAMBDA RL_O37; do
