#!/bin/bash
# ORDER Q — the walk-forward per-entrant emit. ORDER K's run_emit_K.sh with RL_O37 passed
...
for V in RL_O35 RL_O36 RL_O37 RL_O38A RL_O38B1 RL_O38B2 RL_O36_LAM_S1 RL_O36_TALL RL_O36_FLOORFIX RL_O36_KAPPA RL_O36_GAMMA \
...
echo "  emit starting $(date -u +%H:%M:%S)  (RL_O37=${RL_O37:-unset} A=${RL_O38A:-unset} B1=${RL_O38B1:-unset} B2=${RL_O38B2:-unset})"
S=$(date +%s)
