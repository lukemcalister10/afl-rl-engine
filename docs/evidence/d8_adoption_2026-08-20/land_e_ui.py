#!/usr/bin/env python3
"""THE D8 ADOPTION, LANDING STEP E — THE UI BUNDLES. BOTH WRITERS. THIS IS THE THRICE-PROVEN TRAP.
...
spec=importlib.util.spec_from_file_location('rm_d8adopt',P('engine','rl_after','ingestion','round_movers.py'))
rm=importlib.util.module_from_spec(spec); sys.modules['rm_d8adopt']=rm; spec.loader.exec_module(rm)
