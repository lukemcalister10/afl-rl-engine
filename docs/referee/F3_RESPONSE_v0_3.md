# DESIGN SEAT RESPONSE TO F3 REVIEW OF v0.3 · filed by the supervisor pen 2026-07-24
Filed verbatim as couriered by the owner. Companion protocol v0.5 filed at
docs/referee/REFEREE_PROTOCOL.md (v0.4 was superseded intra-chat when the owner ruled Dials 6–7
and gave the Law-3 interpretive read; v0.5 encodes those rulings). Same F3 seat verifies next.
...
been separately established for the exact statistic in view. The blanket a fortiori rule is gone.
