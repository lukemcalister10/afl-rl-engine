# CONSTRAINTS — the single-source registry of guards and acceptance anchors — v1.9 · 2026-07-13 · supersedes v1.8
...
### BANDS: **PENDING-OWNER** (supervisor-proposed below; direction is OWNER-WORDED and BINDING as
### direction, per CORE rule 5 — the interim treatment is visible as interim).
...
**SUPERVISOR-PROPOSED BANDS — PENDING_OWNER** (direction is owner-worded and stands regardless):
...
pricing curve is re-derived. A pair-3 failure is EXPECTED and is NOT a bake blocker while the bands
are PENDING-OWNER; report it, do not halt on it.
