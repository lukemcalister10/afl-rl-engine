# 00_MANIFEST — v4.35 · 2026-07-16 · supersedes v4.34
...
|---|---|---|---|
| **00_MANIFEST** | **v4.35** | 0 | first, always |
...
| **DECISIONS** | **v110** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
