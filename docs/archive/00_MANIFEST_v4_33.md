# 00_MANIFEST — v4.33 · 2026-07-16 · supersedes v4.32
...
|---|---|---|---|
| **00_MANIFEST** | **v4.33** | 0 | first, always |
...
| **DECISIONS** | **v108** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
