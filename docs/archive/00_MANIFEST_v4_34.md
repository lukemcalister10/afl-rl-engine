# 00_MANIFEST — v4.34 · 2026-07-16 · supersedes v4.33
...
|---|---|---|---|
| **00_MANIFEST** | **v4.34** | 0 | first, always |
...
| **DECISIONS** | **v109** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
