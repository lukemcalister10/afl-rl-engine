# CORE — AFL SuperCoach RL engine — v2.8 · 2026-07-15 · supersedes v2.7
### v2.8 (same day): P1 — THE SEAM PACK SLIMS TO TIER-0 (owner-ruled 2026-07-15). Project knowledge carries
### manifest · CORE · HANDOVER · DECISIONS · SSI. **CONSTRAINTS + the acceptance JSON are REPO-ONLY**: fetch
### and grep them when judging a board — assert the JSON entries you need, never absorb the prose. Rationale:
### PK is paid in full in every conversation from turn zero; Tier-1 docs are needed only at prescreen.
...
(manifest · CORE · HANDOVER · DECISIONS · SSI — Tier-0 plus the invariant, synced by the owner at each
seam; **CONSTRAINTS + the acceptance JSON are REPO-ONLY as of 2026-07-15, P1** — fetched and grepped when
judging a board, never absorbed) so an incoming seat is useful in its first reply instead of paying a clone-and-read tax.
