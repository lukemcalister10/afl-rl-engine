# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v371 2026-07-17 · PEN: ITEM 398: DOC AUDIT (owner-requested) — DECISIONS v124 §3 STALE (done audit-shards + v4.53/rev160 PK ref; fold-fix at next bump); viewing directive base 3055ea5 gate-RED (HOLD banner added); BAKE_RUNBOOK predates saga (STALE banner added, rewrite pre-bake); register date frozen 07-17; SSI guard-6 fold post-bake; superseded directives archive at seam · prior: ITEM 397
