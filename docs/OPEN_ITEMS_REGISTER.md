# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v375 2026-07-17 · PEN: ITEM 402: BAKE FIRED + PARALLEL STORE-WRITE FIRED (owner ruled bake-now + parallel weekly-loop). DIRECTIVE_BAKE_v2_11 (boot re-stamp verify-before-stamp + close guard bypass + reproduction gate + bake prep to tag-ready; reviews WAIVED; tag/promote owner-only) + DIRECTIVE_STOREWRITE (go-live apply under 5 SSI guards + dedup ledger, gated OFF, scratch/dry-run proven, 5x single-env stability) — parallel, disjoint. Filed main 0d998e4. Tracking = 3rd track, noted · prior: ITEM 401
