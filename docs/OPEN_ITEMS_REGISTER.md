# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v380 2026-07-22 · PEN: ITEM 407: PHASE-2 CI HARNESS MIGRATION BUILD DIRECTIVE ISSUED + handed to a fresh build seat (owner word 2026-07-22); R19 anchors verified; A2 cross-machine proof DEFERRED→UNMEASURED (no second arch); concurrency clear; deliverable = claims note → prescreen → blind review → owner word · prior: ITEM 406
