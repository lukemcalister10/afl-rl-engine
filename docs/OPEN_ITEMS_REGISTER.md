# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v378 2026-07-17 · PEN: ITEM 405: DOC AUDIT round 2 — FIXED 1 critical contradiction (5 superseded directives dispatch-pin/env-pin/F6/F7/viewing-pack were live+unbannered, contradicting the round-14 bake pivot → ARCHIVED; only bake+store-write live now, main 8953679). Verified clean: one-each pack, all cross-refs historical, rev164 engine pins match live engine, all manifest-named docs exist, no live doc frames dispatch/viewing as current plan. Minor: register header date frozen 07-17 · prior: ITEM 404
