# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v362 2026-07-17 · PEN: ITEM 389: F6 SCOPE=ONE FALSIFIED by the viewing render (HALTED, PR#122) — residual live isotonic fits at _merged_recover.py:463/:466 flip the board on a non-clean box (d7a95e8d, Sheezel -95, 5/5); F6 froze only the V0 surface; item 388 corrected; owner A/B pending (retry-clean vs extend the freeze) · prior: ITEM 388
