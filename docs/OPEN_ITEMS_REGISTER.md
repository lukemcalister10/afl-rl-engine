# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v364 2026-07-17 · PEN: ITEM 391: F7 FALSIFIED :463/:466 (Job-1, correctly) — REAL residual = np.interp CROSS-BUILD divergence, RANK-UNSAFE (top-6/top-15 reorder); NO env pin in repo = root cause; F7 HALTED out-of-fence; owner remediation ruling pending (PIN ENV vs freeze board output vs keep gate); supervisor recommends PIN ENV · prior: ITEM 390
