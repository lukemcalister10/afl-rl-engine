# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v377 2026-07-17 · PEN: ITEM 404: ROTATION HANDOFF — HANDOVER rev164 + manifest v4.57 + DECISIONS v125 filed (main 55831ad); rev163/v4.56/v124 archived. rev164 standalone: determinism pivot (bake round-14 via gate), boot-identity fix, go-live truth, bake+store-write firing, + §3 CALIBRATION MANDATE (trust broken) + §4 correction ledger. DECISIONS §3 stale to-dos fixed; viewing WAIVED. PK now behind (sync v4.57/rev164/v125 at seam). Owner called rotation; supervisor agreed · prior: ITEM 403
