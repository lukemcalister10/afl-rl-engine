# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v361 2026-07-17 · PEN: ITEM 388: F6 owner-ruled RIDE-AS-IS (no lite/no re-audit) + prescreen GREEN (store untouched, k=0=0 rows, PR#121 540b62f) + viewing directive re-based to F6 head 540b62f (07-19) w/ the LEGE=0 fix; owner launches the read-only render next · prior: ITEM 387
