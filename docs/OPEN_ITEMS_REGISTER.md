# OPEN ITEMS REGISTER — the single durable list · maintained by the supervisor pen · v367 2026-07-17 · PEN: ITEM 394: CONTAINER-#2 GATE RED — env-pin (wheel) INSUFFICIENT: identical pinned numpy+BLAS, board STILL flips (d7a95e8d) → divergence is CPU-DISPATCH not the wheel (wheel ruled out); gate WORKED (caught rank-unsafe board pre-bake); lineage intact (3055ea5 has v0surf.pkl; fc7045d6 do-not-merge); owner A/B pending (dispatch-pin vs ship-now-gated), rec A · prior: ITEM 393
