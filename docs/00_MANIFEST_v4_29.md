# 00_MANIFEST — v4.29 · 2026-07-16 · supersedes v4.28
...
|---|---|---|---|
| **00_MANIFEST** | **v4.29** | 0 | first, always |
| **CORE** | **v2.8** | 0 | in full — BINDING. |
| **HANDOVER** | **rev143** | 0 | THE POST-BAKE SEAM handover — the merged PVC+FLEX chapter's whole queue. |
| **DECISIONS** | **v105** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
