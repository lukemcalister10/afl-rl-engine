# 00_MANIFEST — v4.40 · 2026-07-16 · supersedes v4.39
...
|---|---|---|---|
| **00_MANIFEST** | **v4.40** | 0 | first, always |
| **CORE** | **v2.8** | 0 | in full — BINDING. |
| **HANDOVER** | **rev147** | 0 | PRE-ROTATION — the Leg-B story (now four iterations, closed by R105.4) · segment 4 in flight · the queue to v2.11 · standing conduct. |
| **DECISIONS** | **v114** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
...
| **acceptance_v1_19.json** | **v1.19** | 1 | REPO-ONLY (P1) — leg_b rho_construction (weight-don't-gate) + the λ pre-gate + `standing_fails` + `audit_rule`. |
