# 00_MANIFEST — v4.31 · 2026-07-16 · supersedes v4.30
### v4.31 (seat 8's pen): **G-Y0 → BINDING, population-level** (owner-ruled; CONSTRAINTS → **v1.18** ·
### DECISIONS → **v107** · register v163 item 184). All six spec-§6 rulings are IN; the PVC+FLEX
### chapter waits only on the owner's FIRE word (Leg-A directive standing). Nothing else moved.
...
|---|---|---|---|
| **00_MANIFEST** | **v4.31** | 0 | first, always |
| **CORE** | **v2.8** | 0 | in full — BINDING. |
| **HANDOVER** | **rev143** | 0 | THE POST-BAKE SEAM handover — the merged PVC+FLEX chapter's whole queue. |
| **DECISIONS** | **v107** | 0 | rulings + the owner's CURRENT to-dos. Read the register for verbatim. |
