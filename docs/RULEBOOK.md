...
- A rule that cannot currently be measured is reported UNMEASURED — never assumed
  passing, never silently waived. (Currently UNMEASURED at R19: G-COHORT — needs the
  walk-forward book; conservation ledger — needs the leg-b movement ledger. Both come
  back green-or-red with the harness migration.)
